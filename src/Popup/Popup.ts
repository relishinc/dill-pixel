 ...
 */
export abstract class Popup extends PIXI.Container implements IPopup {
    /** @inheritdoc */
    public get id(): string { return this._id!; }
    /** This is used to prevent duplicate calls to e.g. {@link hide} */
    public get state(): POPUP_STATE { return this._state; }
    /** @inheritdoc */
    ...
    /** @inheritdoc */
    public init(pSize: PIXI.Point): void {
    ...
    public destroy(options?: Parameters<typeof PIXI.Container.prototype.destroy>[0]): void {
