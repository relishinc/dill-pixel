...
export class WebEventsManager {
   ...
   */
  public registerVisibilityChangedCallback(pCallback: VisibilityChangedCallback): boolean {
   ...
   */
  public unregisterVisibilityChangedCallback(pCallback: VisibilityChangedCallback): void {
    const index = this._visibilityChangedCallbacks.indexOf(pCallback);
