...
export class TouchManager {
    ...
    protected _swipePrevPos: PIXI.Point;
    protected _pinchPrevDist: number;
    protected _swipeAccum: PIXI.Point;
    ...
    protected _onSwipe: ((pDelta: PIXI.Point) => void) | undefined;
    protected _onSwipeStart: ((pPos: PIXI.Point) => void) | undefined;
    protected _onSwipeEnd: ((pPos: PIXI.Point) => void) | undefined;
    ...
    constructor(pEventSystem: EventSystem, pTarget: PIXI.DisplayObject) {
        ...
        this._swipePrevPos = new PIXI.Point();
        this._pinchPrevDist = 0;

        this._swipeAccum = new PIXI.Point();
        this._pinchAccum = 0;
     ...
     * @param pValue
     */
    public set onSwipe(pValue: ((pDelta: PIXI.Point) => void) | undefined) {
    ...
    public set onSwipeStart(pValue: ((pDelta: PIXI.Point) => void) | undefined) {
     ...
     * @param pValue
     */
    public set onSwipeEnd(pValue: ((pDelta: PIXI.Point) => void) | undefined) {
    ...
    protected onTouchMove(pEvent: FederatedPointerEvent): void {
        ...
        if (this._touches.length === 1 && this._onSwipe !== undefined) {
            const pos: PIXI.Point = this.getTouchPos(this._touches[0], GestureType.SWIPE);
            const delta: PIXI.Point = PointUtils.subtract(pos, this._swipePrevPos);
            if (!this._isSwiping) {
     ...
     */
    protected getTouchPos(pData: FederatedPointerEvent, pGesture: GestureType): PIXI.Point {
