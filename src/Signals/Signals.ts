...
export class Signals {
	...
	public static unregisterFocusables = new Signal<(focusables: (IFocusable | ((it: IFocusable) => boolean))[]) => void>();
	...
	public static showLoadScreen = new Signal<(opts: {
		callback: () => void,
		loadScreen: string,
		stateData: any,
		firstLoad?: boolean
	...
	public static hideLoadScreen = new Signal<(data: {
		callback: () => void,
		loadScreen: string,
	}) => void>();
	...
	public static loadAudioFromAssetMap = new Signal<(opts: {
		assets: AssetMapAudioData[],
		progressCallback: (progress: number) => void,
		callback: () => void
	}) => void>()
	...
	public static loadAudio = new Signal<(opts: {
		assets: string[];
		category: string;
		callback: () => void
	}) => void>();
	public static stopAudio = new Signal<(id: string) => void>();
	public static audioLoadError = new Signal<(opts: {
		id: string,
		category: string,
		src: string,
		fallback: string[],
