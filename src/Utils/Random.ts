...
/**
 * Find a float between the x,y of a PIXI.Point
 * @param pPoint
 * @returns number
 */
export function floatBetweenPoint(pPoint: PIXI.Point): number {
...
/**
 * Find an int between the x,y of a PIXI.Point
 * @param pPoint
 * @returns number
 */
export function intBetweenPoint(pPoint: PIXI.Point): number {
