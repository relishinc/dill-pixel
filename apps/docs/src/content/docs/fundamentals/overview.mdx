...
The [Application](/fundamentals/application) is the entry point for your game. It is responsible for initializing the game, loading assets, and managing the game loop.

## Signals

Dill Pixel uses [Signals](/fundamentals/signals) as the reccommended way to handle events and callbacks in your game.
