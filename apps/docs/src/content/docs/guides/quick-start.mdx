...
```bash
npx create-dill-pixel@next my-application
```
...
```bash
npx create-dill-pixel@next my-application --use-pnpm
```
...
<Tabs>
  <TabItem label={'npm'}>
    <Code code={`npm i dill-pixel@next`} lang="bash" />
  </TabItem>
  <TabItem label={'yarn'}>
    <Code code={`yarn add dill-pixel@next`} lang="bash" />
  </TabItem>
  <TabItem label={'pnpm'}>
    <Code code={`pnpm install dill-pixel@next`} lang="bash" />
  </TabItem>
</Tabs>
...
<Aside type="tip">
  ...
  repository](https://github.com/relishinc/dill-pixel/tree/main/docs/examples/hello-world)
</Aside>
