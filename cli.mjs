    ...
    switch (args[1]) {
      case 'generate':
        ...
        try {
          ...
          console.log(bold(green(`Dill Pixel has finished generating your voiceover CSV(s)! Find them in "${voCSVDirectory}."`)));
        } catch (e) {
          console.log(e);
    ...
    switch (args[1]) {
      ...
      case 'captions':
        ...
        try {
          ...
          console.log(bold(green(`Dill Pixel has finished generating your closed captioning files! Find them in "${captionsOutputDirectory}/cc.json"`)));
        } catch (e) {
