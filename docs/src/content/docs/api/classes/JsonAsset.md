...
> **new JsonAsset**\<`T`\>(`assetName`, `assetPath`?): [`JsonAsset`](/api/classes/jsonasset/)\<`T`\>
...
[`JsonAsset`](/api/classes/jsonasset/)\<`T`\>
...
[src/load/assets/JsonAsset.ts:6](https://github.com/relishinc/dill-pixel/blob/c79d8e8552aaa0f13a29535c819ae67d025b4669/src/load/assets/JsonAsset.ts#L6)
...
[src/load/assets/JsonAsset.ts:13](https://github.com/relishinc/dill-pixel/blob/c79d8e8552aaa0f13a29535c819ae67d025b4669/src/load/assets/JsonAsset.ts#L13)
