 ...
 */
export class StorageAdapter<O = any> extends Plugin<O> implements IStorageAdapter {
  /**
   ...
   * @returns {Promise<O> | O | null} A promise that resolves with the loaded data, or the loaded data if the load operation is synchronous, or null if no data was found.
   */
