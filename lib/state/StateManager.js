...
export class StateManager extends Container {
     ...
     */
    register(pIdOrClass, pCreate, autoAddAssets = true) {
    ...
    startTransition(pStateId, pLoadScreen) {
        ...
        if (data === undefined) {
            this.logE('%c%s%c has not been registered as a state. Please include it in your registerState ' + 'implementation.', LogUtils.STYLE_RED_BOLD, pStateId, LogUtils.STYLE_BLACK);
            return;
        }
