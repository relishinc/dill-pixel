            ...
            if (pAssets !== undefined) {
                ...
                for (const asset of assets) {
                    ...
                    if (asset instanceof AssetMapAudioData) {
                        ...
                        Assets.add(asset.assetName, src, (asset === null || asset === void 0 ? void 0 : asset.data) || null);
                        defaultAssets.push(asset.assetName);
                    }
                }
                if (audioAssets.length > 0) {
                    yield Assets.load(audioAssets.map((asset) => asset.getResource().src), this.onPixiLoadProgress);
                    ...
                    const loaderResult = yield Assets.load(defaultAssets, this.onPixiLoadProgress).catch((e) => this.onPixiLoadError(e));
