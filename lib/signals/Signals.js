...
export class Signals {
    ...
    static { this.stateTransitionStart = new Signal(); }
    static { this.stateTransitionComplete = new Signal(); }
    ...
    static { this.audioContextSuspendedError = new Signal(); }
    static { this.audioLoadError = new Signal(); }
    static { this.onAudioCategoryVolumeChanged = new Signal(); }
