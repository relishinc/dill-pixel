...
class es extends M {
  constructor() {
    super(), this.id = "scenes", this.onSceneChangeStart = new l(), this.onSceneChangeComplete = new l(), this.view = new X(), this.isFirstScene = !0, this.scenes = [], this._sceneModules = /* @__PURE__ */ new Map(), this._lastScene = null, this._defaultLoadMethod = "immediate", this._debugVisible = !1, C(this);
  }
...
class ss extends M {
  ...
  _onGamepadDisconnected(e) {
    this._deactivateGamepad(e.gamepad.id), this.sendAction(x.Pause), this.onGamepadDisconnected.emit(e.gamepad), this.activeGamepads.size === 0 && this._deactivateController(I.Gamepad);
  }
}
class is extends M {
  constructor() {
...
class ie extends fs {
  constructor(e = {}) {
    ...
    }, C(this), this.config = Object.assign({ ..._s }, e), this.on("added", this._added), this.on("childAdded", this.handleChildAdded), this.on("childRemoved", this.handleChildRemoved), this.layout();
  }
  get flexChildren() {
  ...
  _layout() {
    ...
    }, ft = (f) => o === "row" ? f : Fe, _t = (f) => o === "column" ? f : Me, Te = (f, b, y, U) => {
      const w = (U === "row" ? t : s) - (y - b);
    ...
    ge.forEach((f, b) => {
      if (!f)
        return;
      const y = f;
      r === "wrap" && ut(y, c, d) && (Te(Z, me, o === "column" ? d - n : c - n, o), ct(), Z = [], me = c), Z.push({ index: b, width: y.width, height: y.height }), R[b] = { x: ft(c), y: _t(d) }, dt(y);
    }), Te(Z, me, o === "column" ? d - n : c - n, o), pt(R, ge), u = R, ge.forEach((f, b) => {
      const y = f, { x: U, y: w } = u[b] || { x: 0, y: 0 };
      y.position.set(U, w);
    });
...
class Ds extends M {
  ...
  async play(e, t = "sfx", s) {
    ...
    if (n) {
      ...
      const o = n.add(e, new Ye(e, n, this)), r = await P.play(e, s);
  ...
  _verifySoundId(e) {
    ...
    if (!P.exists(e))
      if (P.exists(e + ".mp3"))
        e += ".mp3";
      else if (P.exists(e + ".ogg"))
        e += ".ogg";
      else if (P.exists(e + ".wav"))
        e += ".wav";
      else {
        e = t;
        let s = p.get(e);
