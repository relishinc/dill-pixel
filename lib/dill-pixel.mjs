import { Point as T, isMobile as Qe, Assets as p, Container as X, Graphics as Ae, Texture as gt, Sprite as ke, Text as mt, BitmapText as vt, Rectangle as Ie, EventEmitter as Y, Ticker as G, DOMAdapter as yt, path as te, ExtensionType as Be, LoaderParserPriority as wt, extensions as bt, Application as xt } from "pixi.js";
...
const Ze = process.env.NODE_ENV, W = Ze === "development", Gs = Ze === "production";
function xe(i) {
...
const ye = {
  ...
  constructor(e) {
    m._instance = this, m.mode = e !== void 0 ? e : W ? "development" : "default", ["development", "default", "disabled"].includes(m.mode) || (m.mode = "default");
  }
  static get mode() {
    return m._mode;
  }
...
let _ = m;
const It = (i = 0) => new Promise((e) => setTimeout(e, i * 1e3)), Je = (i) => i && typeof i.then == "function";
function Bt(...i) {
  return new $t(i);
}
class $t {
...
async function Zs(i = { id: "DillPixelApplication" }, e = g, t = Yt, s = !0) {
  s && Xt();
  let n = null;
  ...
  return await It(0.01), await o.postInitialize(), o;
}
class M {
...
class Zt extends M {
  ...
  initialize(e, t) {
    t != null && t.preload && (this._required = t.preload), t != null && t.background && (this._background = t.background), p.setPreferences({ ...Qt, ...t == null ? void 0 : t.assetPreferences }), _.log("AssetsPlugin initialized", e, t, this._required);
  }
  async loadRequired() {
  ...
  async loadAssets(e) {
    return await p.load(e, this._handleLoadProgress), this._markAssetsLoaded(e), Promise.resolve();
  }
  async loadBundles(e) {
  ...
  async unloadSceneAssets(e) {
    ...
    if ((s = (t = e.assets) == null ? void 0 : t.preload) != null && s.assets) {
      const r = e.assets.preload.assets;
      p.unload(r).then(() => {
    ...
    if (t) {
      if ((s = e.assets) != null && s.background) {
        if (e.assets.background.assets) {
          let h = Array.isArray(e.assets.background.assets) ? e.assets.background.assets : [e.assets.background.assets];
          h = h.filter((u) => !this._isAssetLoaded(u)), h.length && p.backgroundLoad(h);
        }
      ...
      if (this._handleLoadStart(), this._handleLoadProgress(0), (o = (n = e.assets) == null ? void 0 : n.preload) != null && o.assets) {
        let h = Array.isArray(e.assets.preload.assets) ? e.assets.preload.assets : [e.assets.preload.assets];
        h = h.filter((u) => !this._isAssetLoaded(u)), h.length && (await p.load(h, this._handleLoadProgress), this._markAssetsLoaded(h));
      }
...
class ss extends M {
  ...
  _onTouchStart() {
    this._activateController(I.Touch);
  }
  _onMouseMove() {
    this._activateController(I.Mouse);
  }
  _onKeyDown() {
    this._activateController(I.Keyboard);
  }
  _onGamepadConnected(e) {
    this._activateController(I.Gamepad), this._activateController(e.gamepad.id), this._activateGamepad(e.gamepad), this.onGamepadConnected.emit(e.gamepad);
  }
...
class rs extends M {
  ...
  initialize(e) {
    var s;
    Vt(this, "removeAllFocusLayers", "_handleGlobalMouseMove", "_handleGlobalPointerDown");
  ...
  addFocusLayer(e, t = !0, s) {
    ...
    let n;
    return this._layers.has(e) ? (_.error(`Layer with ID ${e} already exists.`), n = this._layers.get(e)) : (n = new os(e), this._layers.set(e, n)), (t || this._currentLayerId === null) && this.setFocusLayer(e), s && this.addFocusable(s, e), n;
  }
...
const nt = {
  ...
  sprite: (i) => {
    const e = new ke(i ? Ve(i) : void 0);
    if (!i)
      return e;
    const { position: t, x: s, y: n, anchor: o, pivot: r, scale: a, scaleX: h, scaleY: u, ...c } = i;
    return A({ position: t, x: s, y: n }, e), k({ scale: a, scaleX: h, scaleY: u }, e), be(o, e), L(r, e), S(c, e), e;
  },
  graphics: (i) => {
    const e = new Ae();
    if (!i)
  ...
  button: (i) => {
    const e = J(i ?? {}, He), t = j(He, i ?? {}), s = new ds(e);
    if (!t)
      return s;
  ...
  flexContainer: (i) => {
    const e = J(i ?? {}, Ke), t = j(Ke, i ?? {}), s = new ie(e);
    if (!t)
      return s;
    const { position: n, x: o, y: r, pivot: a, scale: h, scaleX: u, scaleY: c, ...d } = t;
    return A({ position: n, x: o, y: r }, s), k({ scale: h, scaleX: u, scaleY: c }, s), L(a, s), S(d, s), s;
  ...
  uiCanvas: (i) => {
    const e = J(i ?? {}, Xe), t = j(Xe, i ?? {}), s = new ne(e);
    if (!t)
      return s;
    const { position: n, x: o, y: r, pivot: a, scale: h, scaleX: u, scaleY: c, ...d } = t;
    return A({ position: n, x: o, y: r }, s), k({ scale: h, scaleX: u, scaleY: c }, s), L(a, s), S(d, s), s;
  ...
  spine: (i) => {
    ...
    return A({ position: s, x: n, y: o }, t), k({ scale: h, scaleX: u, scaleY: c }, t), be(r, t), L(a, t), S(d, t), t;
  },
  spineAnimation: (i) => {
    const e = new ys(i);
    if (!i)
...
function q(i) {
  return class extends X {
    constructor() {
      super(), i = Object.assign(nt, i), this.make = Ge(i, this, !1), this.add = Ge(i, this, !0);
    }
  };
}
const Ee = class Ee {
...
const Xe = ["debug", "padding", "size", "useAppSize"], ps = N(q());
class ne extends ps {
  constructor(e) {
  ...
  __calculateOuterBounds(e) {
    return new Ie(0, 0, e.width, e.height);
  }
  _childRemoved(e) {
  ...
  applySettings(e, t) {
    ...
    e.x += ee(t.padding.left, s) - ee(t.padding.right, s), e.y += ee(t.padding.top, n) - ee(t.padding.bottom, n);
  }
  drawDebug() {
...
class V extends $ {
  ...
  static makeBacking(e, t) {
    ...
    if (V.BACKING_TEXTURE === void 0) {
      const a = new Ae();
      a.rect(0, 0, 100, 100).fill("white"), V.BACKING_TEXTURE = g.getInstance().renderer.generateTexture(a);
    }
    const o = new $();
    o.sortableChildren = !1;
    const r = o.addChild(new ke(V.BACKING_TEXTURE));
   ...
   */
  _initialize() {
    this.app.focus.addFocusLayer(this.id, !1), this.config.backing && (this.backing = this.add.existing(V.makeBacking(this.config.backing, this.app.size)), this.backing.eventMode = "static", this.config.closeOnPointerDownOutside && (this.backing.once("click", this.close), this.backing.once("tap", this.close))), this.view = this.add.container(), this.view.eventMode = "static";
  }
}
const vs = N(q());
class ys extends vs {
...
const Se = class extends Y {
  ...
  play(i) {
    ...
    t && console.assert(t > e, "End time is before start time"), this._speed = s, this._volume = o, this._loop = !!n, this._muted = r, this.refresh(), this.loop && t !== null && (console.warn('Looping not support when specifying an "end" time'), this.loop = !1), this._start = e, this._end = t || this._duration, this._start = Math.max(0, this._start - Se.PADDING), this._end = Math.min(this._end + Se.PADDING, this._duration), this._source.onloadedmetadata = () => {
      this._source && (this._source.currentTime = e, this._source.onloadedmetadata = null, this.emit("progress", e, this._duration), G.shared.add(this._onUpdate, this));
   ...
   */
  _onComplete() {
    G.shared.remove(this._onUpdate, this), this._internalStop(), this.emit("progress", 1, this._duration), this.emit("end", this);
  }
  /** Don't use after this. */
  destroy() {
    G.shared.remove(this._onUpdate, this), this.removeAllListeners();
...
class Ms extends Y {
  constructor(e) {
    super(), this.id = Es++, this._media = null, this._paused = !1, this._muted = !1, this._elapsed = 0, this.init(e);
  }
  /**
   * Set a property by name, this makes it easy to chain values
   * @param name - Name of the property to set.
  ...
  refresh() {
    ...
    Pe.setParamValue(this._gain.gain, o * n * s), Pe.setParamValue(this._source.playbackRate, this._speed * t.speed * e.speed), this.applyFilters();
  }
  ...
  enableTicker(e) {
    G.shared.remove(this._updateListener, this), e && G.shared.add(this._updateListener, this);
  }
  /** The current playback progress from 0 to 1. */
  get progress() {
...
const ht = class extends at {
  ...
  cloneBufferSource() {
    ...
    e.buffer = i.buffer, Pe.setParamValue(e.playbackRate, i.playbackRate.value), e.loop = i.loop;
...
const B = class {
  ...
  static from(i) {
    ...
    const t = H().useLegacy ? new Ss() : new Fs();
    return new B(t, e);
  }
  /**
   * Use `Sound.from`
   ...
   */
  preferUrl(i) {
    const [e] = i.map((t) => ({ url: t, ext: te.extname(t).slice(1) })).filter(({ ext: t }) => re[t]).sort((t, s) => oe.indexOf(t.ext) - oe.indexOf(s.ext));
    if (!e)
...
class Ts {
   ...
   */
  init() {
    return this.supported && (this._webAudioContext = new K()), this._htmlAudioContext = new Cs(), this._sounds = {}, this.useLegacy = !this.supported, this;
  }
  /**
...
const Ne = (i) => {
  ...
  return (!t || i.src === t) && (t = te.basename(e, te.extname(e))), t;
}, zs = {
  extension: Be.Asset,
  detection: {
    test: async () => !0,
  ...
  loader: {
    ...
    test(i) {
      const e = te.extname(i).slice(1);
      return !!re[e] || ks.some((t) => i.startsWith(`data:${t}`));
    },
...
class g extends xt {
  ...
  async initialize(e) {
    ...
    if (g.instance = this, this.config = Object.assign({ ...$s }, e), e.container && (g.containerElement = e.container), _.initialize(this.config.logger), await this.boot(this.config), await this.preInitialize(this.config), await this.initAssets(), await this.init(this.config), await this.registerDefaultPlugins(), this.config.plugins && this.config.plugins.length > 0)
  ...
  async registerDefaultPlugins() {
    ...
    (this.config.showStats === !0 || W && this.config.showStats !== !1) && await this.loadPlugin({
      id: "stats",
   ...
   */
  async _setup() {
    return W && (globalThis.__PIXI_APP__ = this), this.webEvents.onResize.connect(this._resize, -1), this.scenes.view.label = "SceneManager", this.stage.addChild(this.scenes.view), this.stage.addChild(this.popups.view), this.focus.view.label = "FocusManager", this.stage.addChild(this.focus.view), this._resize(), Promise.resolve();
  }
}
const oi = F.Collector, ri = F.CollectorArray, ai = F.CollectorLast, hi = F.CollectorUntil0, li = F.CollectorWhile0, ui = F.SignalConnections;
export {
  C as Action,
  st as ActionContext,
  as as Animated,
