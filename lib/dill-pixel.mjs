import { Application as qe, Container as G, Sprite as le, Graphics as ue, Text as Qe, BitmapText as Ze, HTMLText as yt, Texture as Je, Point as L, Rectangle as Pe, TextStyle as wt, HTMLTextStyle as bt, isMobile as et, Assets as F, EventEmitter as N, Ticker as K, DOMAdapter as xt, path as se, ExtensionType as Ue, LoaderParserPriority as Ct, extensions as Pt } from "pixi.js";
...
ce.CollectorArray = kt;
var de = {};
Object.defineProperty(de, "__esModule", { value: !0 });
de.CollectorLast = void 0;
const Et = z;
...
fe.CollectorUntil0 = void 0;
const Lt = z;
class Tt extends Lt.Collector {
  constructor() {
...
fe.CollectorUntil0 = Tt;
var _e = {};
Object.defineProperty(_e, "__esModule", { value: !0 });
_e.CollectorWhile0 = void 0;
const Ft = z;
class Dt extends Ft.Collector {
  constructor() {
    super(...arguments), this.result = !1;
  }
  handleResult(e) {
...
_e.CollectorWhile0 = Dt;
var pe = {}, ge = {};
Object.defineProperty(ge, "__esModule", { value: !0 });
ge.SignalConnectionImpl = void 0;
class zt {
  /**
...
ge.SignalConnectionImpl = zt;
var me = {};
Object.defineProperty(me, "__esModule", { value: !0 });
me.SignalLink = void 0;
class Ee {
...
let Ut = class {
  constructor() {
    this.head = new It.SignalLink(), this.hasNewLinks = !1, this.emitDepth = 0, this.connectionsCount = 0;
  }
  /**
  ...
  connect(e, t = 0) {
    ...
    return this.emitDepth > 0 && (this.hasNewLinks = !0, s.newLink = !0), new Ot.SignalConnectionImpl(s, () => this.decrementConnectionCount());
  }
...
const tt = process.env.NODE_ENV, D = tt === "development", Ws = tt === "production", p = class p {
  constructor(e = "") {
    this._namespace = e, p._instance = this;
  }
  static initialize(e = "") {
    if (p._instance)
  ...
  static log(...e) {
    !p._instance || !p._instance._namespace ? console.log(...e) : (console.log(`%c[${p._instance._namespace}]`, "background: lightblue; color: black;", ...e), D && p.trace());
  }
  static error(...e) {
    !p._instance || !p._instance._namespace ? console.error(...e) : (console.error(`%c[${p._instance._namespace}]`, "background: red; color: black;", ...e), D && p.trace());
  }
  static warn(...e) {
    !p._instance || !p._instance._namespace ? console.warn(...e) : (console.warn(`%c[${p._instance._namespace}]`, "background: orange; color: black;", ...e), D && p.trace());
  }
  static trace() {
...
p._instance = null;
let f = p;
const Rt = (i = 0) => new Promise((e) => setTimeout(e, i * 1e3)), st = (i) => i && typeof i.then == "function";
function Bt(...i) {
  return new jt(i);
}
class jt {
...
async function ie(i) {
  let e, t;
  return st(i.module) ? (e = await i.module, t = i != null && i.namedExport ? e[i.namedExport] : e.default) : typeof i.module == "function" ? Gt(i.module) ? (e = i.module, t = e) : (e = await i.module(), t = i != null && i.namedExport ? e[i.namedExport] : e.default) : (e = i.module, t = e), t;
}
function O(i, e = !1, t = 0, s = 0) {
  if (i instanceof L)
    t = i.x, s = i.y;
...
const qs = window.devicePixelRatio > 1 || window.matchMedia && window.matchMedia(
  ...
  async save(e, t, s, n = !0) {
    ...
    for (let h = 0; h < o.length; h++) {
      ...
      if (typeof o[h] == "object") {
        const x = o[h];
        u = x.adapterId, c = x.awaitSave ?? !1;
      } else
        u = o[h], c = n;
      const _ = this._adapters.get(u);
      if (!_)
        throw new Error(`Adapter ${o[h]} not found`);
      c ? r.push(await _.save(t, s)) : r.push(void _.save(t, s));
    }
    return r;
  }
  /**
...
const nt = {}, Se = {}, Xt = "8.4.1";
function Yt() {
  let i = `%cDill Pixel Game Framework v${Xt}`;
...
async function Zs(i, e = { id: "DillPixelApplication" }, t = Nt, s = !0) {
  s && Yt();
  let n = null;
  ...
  e.resizeToContainer && (e.resizeTo = n), e.container = n;
  const o = new i();
  if (await o.initialize(e), n)
    n.appendChild(o.canvas);
  else
    throw new Error("No element found to append the view to.");
  return await Rt(0.01), await o.postInitialize(), o;
}
class E {
  constructor(e = "Plugin") {
    this.id = e, this._signalConnections = new T.SignalConnections(), b(this), this.__dill_pixel_method_binding_root = !0;
  }
  get app() {
...
class Zt extends E {
  constructor() {
    super(...arguments), this.id = "assets";
  }
  destroy() {
  }
}
class Jt extends E {
   ...
   */
  constructor() {
    super(), this.id = "webEvents", this.onResize = new l(), this.onVisibilityChanged = new l(), b(this);
  }
  get app() {
    return v.getInstance();
  }
...
class es extends E {
  constructor() {
    super(), this.id = "scenes", this.onSceneChangeStart = new l(), this.onSceneChangeComplete = new l(), this.view = new G(), this.isFirstScene = !0, this.scenes = [], this._sceneModules = /* @__PURE__ */ new Map(), this._lastScene = null, this._defaultLoadMethod = "immediate", this._debugVisible = !1, b(this);
  }
  ...
  async _createCurrentScene() {
    ...
    if (!t)
      throw new Error(`Couldn't load ${this._currentSceneId}"`);
    this.currentScene = new t(), this.currentScene.id = this._currentSceneId, this.onSceneChangeStart.emit({ exiting: ((s = this._lastScene) == null ? void 0 : s.id) || null, entering: this.currentScene.id });
  }
  _queueComplete() {
  ...
  _createDebugMenu() {
    ...
    e.style.cssText = "cursor:pointer; position:absolute;width:100%; font-style:normal; font-size:20px; top:50%; left:50%; transform:translate(-50%, -50%); text-align:center; pointer-events:none", e.innerHTML = "🎬", this._debugMenu.appendChild(e), (v.containerElement || document.body).appendChild(this._debugMenu), this._sceneSelect = document.createElement("select"), this._sceneSelect.style.cssText = "padding:0; border-radius:5px; opacity:0; width:48px; height:48px; cursor:pointer", this._sceneSelect.value = this.defaultScene || "";
...
var R = /* @__PURE__ */ ((i) => (i.Keyboard = "keyboard", i.Gamepad = "gamepad", i.Mouse = "mouse", i.Touch = "touch", i))(R || {}), ot = /* @__PURE__ */ ((i) => (i.General = "general", i.Menu = "menu", i.Game = "game", i))(ot || {}), w = /* @__PURE__ */ ((i) => (i.Up = "up", i.Down = "down", i.Left = "left", i.Right = "right", i.Action = "action", i.Next = "next", i.Back = "back", i.Pause = "pause", i.Unpause = "unpause", i.Start = "start", i.Menu = "menu", i))(w || {});
const ts = [
  w.Up,
  w.Down,
  w.Left,
...
class ss extends E {
  ...
  async initialize(e, t = Be) {
    this.options = { ...Be, ...t }, e.stage.eventMode = "static", e.stage.on("touchstart", this._onTouchStart), e.stage.on("globalmousemove", this._onMouseMove), window.addEventListener("keydown", this._onKeyDown), window.addEventListener("gamepadconnected", this._onGamepadConnected), window.addEventListener("gamepaddisconnected", this._onGamepadDisconnected);
  }
  destroy() {
  ...
  _onTouchStart() {
    this._activateController(R.Touch);
  }
  _onMouseMove() {
    this._activateController(R.Mouse);
  }
  _onKeyDown() {
    this._activateController(R.Keyboard);
  }
  _onGamepadConnected(e) {
    this._activateController(R.Gamepad), this._activateController(e.gamepad.id), this._activateGamepad(e.gamepad), this.onGamepadConnected.emit(e.gamepad);
  }
  _onGamepadDisconnected(e) {
    this._deactivateGamepad(e.gamepad.id), this.sendAction(w.Pause), this.onGamepadDisconnected.emit(e.gamepad), this.activeGamepads.size === 0 && this._deactivateController(R.Gamepad);
  }
}
class is extends E {
  constructor() {
...
class ns extends G {
  constructor(e) {
    super(), b(this), this._config = {
      color: 65535,
      shape: "rounded rectangle",
      radius: 8,
      lineWidth: 2,
      ...e
    }, this._graphics = new ue(), this.addChild(this._graphics);
  }
  draw(e) {
  ...
  setFocusTarget(e) {
    e && (this.focusTarget = e, this.focusBounds = this.focusTarget.getFocusArea().clone(), v.getInstance().ticker.add(this.updatePosition));
  }
  clearFocusTarget() {
...
class rs extends E {
  ...
  initialize(e) {
    var s;
    Wt(this, "removeAllFocusLayers", "_handleGlobalMouseMove", "_handleGlobalPointerDown");
    const t = ((s = e.config) == null ? void 0 : s.focusOptions) || {};
    t.usePixiAccessibility = t.usePixiAccessibility ?? !1, this._focusOutliner = typeof (t == null ? void 0 : t.outliner) == "function" ? new t.outliner() : new ns(t.outliner), this._options = t, this.view.addChild(this._focusOutliner), this._updatePixiAccessibility(), this._setupKeyboardListeners(), this._setupAppListeners();
  }
  destroy() {
  ...
  addFocusLayer(e, t = !0, s) {
    ...
    let n;
    return this._layers.has(e) ? (f.error(`Layer with ID ${e} already exists.`), n = this._layers.get(e)) : (n = new os(e), this._layers.set(e, n)), (t || this._currentLayerId === null) && this.setFocusLayer(e), s && this.addFocusable(s, e), n;
  }
  ...
  _removeTopLayer() {
    var s, n;
    const e = (s = it(this._layers)) == null ? void 0 : s[0], t = (n = Re(this._layers, e)) == null ? void 0 : n[0];
...
function q(i) {
  return class extends i {
    constructor() {
      super(...arguments), this.signalConnections = new T.SignalConnections();
    }
    /**
     * Add signal connections to the container.
     * @param args - The signal connections to add.
...
const ls = ["text", "anchor", "resolution", "roundPixels", "style"];
function C(i, e) {
  for (const t in i)
    try {
      e[t] = i[t];
...
function P(i, e) {
  const t = O(i.position, !1, i.x, i.y);
  e.x = t.x, e.y = t.y;
}
function S(i, e) {
  if (!i)
  ...
  const t = O(i.scale, !1, i.scaleX, i.scaleY);
  e.scale.set(t.x, t.y);
}
function Ce(i, e) {
  if (i !== void 0) {
...
const at = {
  existing: (i, e) => {
    ...
    return P({ position: t, x: s, y: n }, i), S({ scale: r, scaleX: a, scaleY: h }, i), A(o, i), C(u, i), i;
  },
  texture: je,
  container: (i) => {
    const e = new j();
    ...
    return P({ position: t, x: s, y: n }, e), S({ scale: r, scaleX: a, scaleY: h }, e), A(o, e), C(u, e), e;
  },
  sprite: (i) => {
    const e = new le(i ? je(i) : void 0);
    if (!i)
      return e;
    const { position: t, x: s, y: n, anchor: o, pivot: r, scale: a, scaleX: h, scaleY: u, ...c } = i;
    return P({ position: t, x: s, y: n }, e), S({ scale: a, scaleX: h, scaleY: u }, e), Ce(o, e), A(r, e), C(c, e), e;
  },
  graphics: (i) => {
    const e = new ue();
    if (!i)
  ...
  text: (i) => {
    ...
    P({ position: s, x: n, y: o }, t), S({ scale: r, scaleX: a, scaleY: h }, t), A(u, t);
    const c = W(
  ...
  bitmapText: (i) => {
    const e = ee(i ?? {}, ls), t = new Ze(e);
    i != null && i.position && P({ position: i.position, x: i.x, y: i.y }, t), i != null && i.scale && S({ scale: i.scale ?? 1, scaleX: i.scaleX, scaleY: i.scaleY }, t), i != null && i.pivot && A(i.pivot, t);
    const s = W(
      ["x", "y", "position", "text", "roundPixels", "resolution", "style", "anchor", "pivot"],
      i ?? {}
    );
  ...
  button: (i) => {
    const e = ee(i ?? {}, We), t = W(We, i ?? {}), s = new ds(e);
    if (!t)
      return s;
    const { position: n, x: o, y: r, pivot: a, scale: h, scaleX: u, scaleY: c, ..._ } = t;
    return P({ position: n, x: o, y: r }, s), S({ scale: h, scaleX: u, scaleY: c }, s), A(a, s), C(_, s), s;
  },
  flexContainer: (i) => {
    const e = ee(i ?? {}, He), t = W(He, i ?? {}), s = new ne(e);
    if (!t)
      return s;
    const { position: n, x: o, y: r, pivot: a, scale: h, scaleX: u, scaleY: c, ..._ } = t;
    return P({ position: n, x: o, y: r }, s), S({ scale: h, scaleX: u, scaleY: c }, s), A(a, s), C(_, s), s;
  ...
  uiCanvas: (i) => {
    const e = ee(i ?? {}, Ke), t = W(Ke, i ?? {}), s = new oe(e);
    if (!t)
      return s;
    const { position: n, x: o, y: r, pivot: a, scale: h, scaleX: u, scaleY: c, ..._ } = t;
    return P({ position: n, x: o, y: r }, s), S({ scale: h, scaleX: u, scaleY: c }, s), A(a, s), C(_, s), s;
  ...
  spine: (i) => {
    ...
    const { position: s, x: n, y: o, anchor: r, pivot: a, scale: h, scaleX: u, scaleY: c, ..._ } = i;
    return P({ position: s, x: n, y: o }, t), S({ scale: h, scaleX: u, scaleY: c }, t), Ce(r, t), A(a, t), C(_, t), t;
  },
  spineAnimation: (i) => {
    const e = new ys(i);
    if (!i)
...
function Q(i) {
  return class extends G {
    constructor() {
      super(), i = Object.assign(at, i), this.make = Ge(i, this, !1), this.add = Ge(i, this, !0);
    }
  };
}
const Me = class Me {
};
Me.get = Object.assign(at, {});
let Ve = Me;
const us = as(q(Q()));
class j extends us {
  /**
  ...
  constructor(e = { autoResize: !0, autoUpdate: !1, priority: 0 }) {
    super(), this.__config = e, this.__dill_pixel_method_binding_root = !0, b(this), this.on("added", this._added), this.on("removed", this._removed);
  }
  /**
...
const We = ["textures", "cursor", "disabledCursor", "sheet", "enabled"], cs = rt(hs(q(Q())));
class ds extends cs {
  /**
   * @constructor
   ...
   */
  constructor(e) {
    super(), this.onDown = new l(), this.onUp = new l(), this.onUpOutside = new l(), this.onOut = new l(), this.onOver = new l(), this.onClick = new l(), this.onEnabled = new l(), this.onDisabled = new l(), this.onKeyboardEvent = new l(), this._isDownCallbacks = /* @__PURE__ */ new Map(), this._isDownListenerAdded = !1, b(this), this.config = Object.assign(
      {
        textures: { default: "" },
        sheet: void 0,
        enabled: !0,
...
class ii extends G {
  ...
  focusOn(e) {
    ...
    const c = this.viewportHeight / this.scale.y / 2 + o + this.minY - a, _ = this.worldHeight - this.viewportHeight / this.scale.y / 2 + o + this.maxY - a;
    this._targetPivot.y < c ? this._targetPivot.y = c : this._targetPivot.y > _ && (this._targetPivot.y = _);
  }
  updateZoom() {
...
class ni {
  ...
  getEventPosition(e) {
    return e instanceof TouchEvent ? new L(e.touches[0].clientX, e.touches[0].clientY) : new L(e.clientX, e.clientY);
  }
}
const fs = q(Q()), He = [
  "width",
...
class ne extends fs {
  constructor(e = {}) {
    ...
    }, b(this), this.config = Object.assign({ ..._s }, e), this.on("added", this._added), this.on("childAdded", this.handleChildAdded), this.on("childRemoved", this.handleChildRemoved), this.layout();
  }
  get flexChildren() {
  ...
  _layout() {
    var ze, Oe;
    this.config.bindTo && (this.config.width = ((ze = this.config.bindTo) == null ? void 0 : ze.width) ?? 0, this.config.height = ((Oe = this.config.bindTo) == null ? void 0 : Oe.height) ?? 0), this.config.bindToAppSize && (this.config.width = this.app.size.width, this.config.height = this.app.size.height);
    const e = ["flex-start"];
    ...
    let u = [], c = 0, _ = 0, x = 0, Z = 0, Le = 0, Te = 0;
    const V = [], ye = this.children.filter(Boolean);
    let J = [], we = 0;
    const ft = (d, y, g) => o === "row" && y + d.width + n > t || o === "column" && g + d.height + n > s, _t = () => {
      o === "row" ? Le += x + n : Te += Z + n, c = 0, _ = 0, x = 0, Z = 0;
    }, pt = (d) => {
      o === "row" ? (c += d.width + n, x = Math.max(x, d.height)) : (_ += d.height + n, Z = Math.max(Z, d.width));
    }, gt = (d) => o === "row" ? d : Te, mt = (d) => o === "column" ? d : Le, Fe = (d, y, g, $) => {
      const m = ($ === "row" ? t : s) - (g - y);
      d.forEach(({ index: Ie }, be) => {
        let I = 0;
        switch (h) {
          case "flex-start":
            break;
          ...
          case "center":
            ...
            break;
          case "space-between":
            I = d.length > 1 ? be * (m / (d.length - 1)) : 0;
            break;
          case "space-around":
            I = m / d.length * be + m / (2 * d.length);
            break;
          case "space-evenly":
            I = m / (d.length + 1) * (be + 1);
            break;
        }
        $ === "row" ? V[Ie].x += I : V[Ie].y += I;
      });
    }, vt = (d, y) => {
      d.forEach((g, $) => {
        const m = y[$];
    ...
    ye.forEach((d, y) => {
      if (!d)
        return;
      const g = d;
      r === "wrap" && ft(g, c, _) && (Fe(J, we, o === "column" ? _ - n : c - n, o), _t(), J = [], we = c), J.push({ index: y, width: g.width, height: g.height }), V[y] = { x: gt(c), y: mt(_) }, pt(g);
    }), Fe(J, we, o === "column" ? _ - n : c - n, o), vt(V, ye), u = V, ye.forEach((d, y) => {
      const g = d, { x: $, y: m } = u[y] || { x: 0, y: 0 };
      g.position.set($, m);
    });
    const De = this.children.reduce(
      (d, y) => Math.max(d, y.y + y.height),
      0
    );
...
const Ke = ["debug", "padding", "size", "useAppSize"], ps = q(Q());
class oe extends ps {
  constructor(e) {
    super(), this.settingsMap = /* @__PURE__ */ new Map(), this._childMap = /* @__PURE__ */ new Map(), this._reparentAddedChild = !0, this._disableAddChildError = !1, this._canvasChildren = [], this.removeChildren = (t, s) => this._inner.removeChildren(t, s), this.removeChildAt = (t) => this._inner.removeChildAt(t), this.addChildAt = (t, s) => {
      ...
      debug: e.debug === !0,
      padding: xe((e == null ? void 0 : e.padding) ?? 0),
  ...
  set padding(e) {
    this.config.padding = xe(e), this._inner.position.set(this.config.padding.left, this.config.padding.top), this.resize();
  }
  ...
  addElement(e, t) {
    ...
    return n.x < 0 && (s.pivot.x = n.x), n.y < 0 && (s.pivot.y = n.y), e != null && e.flexChildren && this.addSignalConnection(e.onLayoutComplete.connect(this.layout)), this.settingsMap.set(s, {
      ...
      padding: t != null && t.padding ? xe(t.padding) : { top: 0, left: 0, bottom: 0, right: 0 }
  ...
  __calculateOuterBounds(e) {
    return new Pe(0, 0, e.width, e.height);
  }
  _childRemoved(e) {
...
const gs = {
  color: 0,
  alpha: 0.75
}, ms = { backing: !0, closeOnEscape: !0, closeOnPointerDownOutside: !0 };
class H extends j {
  /**
   * Create a new Popup
   ...
   */
  constructor(e, t = {}) {
    super(), this.id = e, this.isShowing = !1, this.config = Object.assign({ id: e, ...ms }, t), this._initialize();
  }
  get data() {
  ...
  static makeBacking(e, t) {
    let s = {};
    typeof e == "object" && (s = e);
    const n = Object.assign({ ...gs }, s);
    if (H.BACKING_TEXTURE === void 0) {
      const a = new ue();
      a.rect(0, 0, 100, 100).fill("white"), H.BACKING_TEXTURE = v.getInstance().renderer.generateTexture(a);
    }
    const o = new j();
    o.sortableChildren = !1;
    const r = o.addChild(new le(H.BACKING_TEXTURE));
   ...
   */
  _initialize() {
    this.app.focus.addFocusLayer(this.id, !1), this.config.backing && (this.backing = this.add.existing(H.makeBacking(this.config.backing, this.app.size)), this.backing.eventMode = "static", this.config.closeOnPointerDownOutside && (this.backing.once("click", this.close), this.backing.once("tap", this.close))), this.view = this.add.container(), this.view.eventMode = "static";
  }
}
const vs = q(Q());
class ys extends vs {
...
class ws extends E {
  constructor() {
    super(...arguments), this.id = "popups", this.view = new j(), this.onShowPopup = new l(), this.onHidePopup = new l(), this._popups = /* @__PURE__ */ new Map(), this._activePopups = /* @__PURE__ */ new Map(), this._currentPopupId = void 0;
  }
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  initialize(e) {
    b(this), this.view.label = "PopupManager", this._setupAppListeners();
  }
  /**
  ...
  async hidePopup(e, t) {
    ...
    if (s)
      return s.beforeHide(), await s.hide(), this.view.removeChild(s), this._activePopups.delete(e), this._currentPopupId = ((n = it(this._activePopups)) == null ? void 0 : n[0]) || void 0, this.onHidePopup.emit({ id: e, data: t }), s.end(), s;
  }
  /**
   * Remove all popups
...
class Xe {
  constructor(e, t, s) {
    this.id = e, this.channel = t, this.manager = s, this.onStart = new l(), this.onStop = new l(), this.onEnd = new l(), this.onPaused = new l(), this.onResumed = new l(), this.onProgress = new l(), this._volume = 1, this._muted = !1, this._isPlaying = !1, b(this), this.muted = this.channel.muted;
  }
  get media() {
    return this._media;
  }
...
let Ps = 0;
const ke = class extends N {
  /** @param parent - Parent element */
  constructor(i) {
    super(), this.id = Ps++, this.init(i);
  }
  /**
  ...
  play(i) {
    ...
    t && console.assert(t > e, "End time is before start time"), this._speed = s, this._volume = o, this._loop = !!n, this._muted = r, this.refresh(), this.loop && t !== null && (console.warn('Looping not support when specifying an "end" time'), this.loop = !1), this._start = e, this._end = t || this._duration, this._start = Math.max(0, this._start - ke.PADDING), this._end = Math.min(this._end + ke.PADDING, this._duration), this._source.onloadedmetadata = () => {
      this._source && (this._source.currentTime = e, this._source.onloadedmetadata = null, this.emit("progress", e, this._duration), K.shared.add(this._onUpdate, this));
   ...
   */
  _onComplete() {
    K.shared.remove(this._onUpdate, this), this._internalStop(), this.emit("progress", 1, this._duration), this.emit("end", this);
  }
  /** Don't use after this. */
  destroy() {
    K.shared.remove(this._onUpdate, this), this.removeAllListeners();
...
class Ls extends N {
  constructor(e) {
    super(), this.id = Ms++, this._media = null, this._paused = !1, this._muted = !1, this._elapsed = 0, this.init(e);
  }
  /**
   * Set a property by name, this makes it easy to chain values
   * @param name - Name of the property to set.
  ...
  refresh() {
    ...
    Ae.setParamValue(this._gain.gain, o * n * s), Ae.setParamValue(this._source.playbackRate, this._speed * t.speed * e.speed), this.applyFilters();
  }
  ...
  play(e) {
    ...
    this._duration = _, this._end = s, this._lastUpdate = this._now(), this._elapsed = t, this._source.onended = this._onComplete.bind(this), this._loop ? (this._source.loopEnd = s, this._source.loopStart = t, this._source.start(0, t)) : s ? this._source.start(0, t, s - t) : this._source.start(0, t), this.emit("start"), this._update(!0), this.enableTicker(!0);
  }
  /** Start the update progress. */
  enableTicker(e) {
    K.shared.remove(this._updateListener, this), e && K.shared.add(this._updateListener, this);
  }
  /** The current playback progress from 0 to 1. */
  get progress() {
...
const ct = class extends ut {
   ...
   */
  get script() {
    return this._script || (this._script = this.context.audioContext.createScriptProcessor(ct.BUFFER_SIZE), this._script.connect(this.context.destination)), this._script;
  }
  /** Cleans up. */
  destroy() {
  ...
  cloneBufferSource() {
    ...
    e.buffer = i.buffer, Ae.setParamValue(e.playbackRate, i.playbackRate.value), e.loop = i.loop;
...
class Ts {
   ...
   */
  init(e) {
    this.parent = e, this._nodes = new dt(this.context), this._source = this._nodes.bufferSource, this.source = e.options.source;
  }
  ...
  async _loadUrl(e) {
    const t = this.parent.url, s = await xt.get().fetch(t);
...
const B = class {
  ...
  static from(i) {
    ...
    const t = X().useLegacy ? new Ss() : new Ts();
    return new B(t, e);
  }
  /**
   * Use `Sound.from`
...
class Y extends ut {
  constructor() {
    const e = window, t = new Y.AudioContext(), s = t.createDynamicsCompressor(), n = t.createAnalyser();
    n.connect(s), s.connect(t.destination), super(n, s), this.autoPause = !0, this._ctx = t, this._offlineCtx = new Y.OfflineAudioContext(
      1,
      2,
...
class Fs {
   ...
   */
  init() {
    return this.supported && (this._webAudioContext = new Y()), this._htmlAudioContext = new Cs(), this._sounds = {}, this.useLegacy = !this.supported, this;
  }
  /**
...
const Ye = (i) => {
  ...
  loader: {
    ...
    test(i) {
      ...
      return !!ae[e] || ks.some((t) => i.startsWith(`data:${t}`));
    },
...
class zs extends E {
  ...
  async play(e, t = "sfx", s) {
    ...
    if (n) {
      ...
      const o = n.add(e, new Xe(e, n, this)), r = await k.play(e, s);
  ...
  load(e, t = "sfx", s) {
    ...
    for (let n of e) {
      ...
      if (o) {
        ...
        const a = o.add(n, new Xe(n, o, this));
  ...
  _verifySoundId(e) {
    ...
    if (!k.exists(e))
      if (k.exists(e + ".mp3"))
        e += ".mp3";
      else if (k.exists(e + ".ogg"))
        e += ".ogg";
      else if (k.exists(e + ".wav"))
        e += ".wav";
      else
  ...
  _setMuted() {
    this._channels.forEach((e) => {
      e.muted = this._muted;
    }), this._muted ? k.muteAll() : k.unmuteAll(), this.onMuted.emit(this._muted);
  }
  /**
   * @private
   */
  _setPaused() {
    this._paused ? k.pauseAll() : k.resumeAll();
  }
  /**
   * Sets the volume of the specified channel.
   * @param {ChannelName} channelName
...
class Is extends E {
   ...
   */
  async initialize(e, t) {
    if (super.initialize(e), this._options = { ...Os, ...t }, this._locale = this._options.defaultLocale, this._options.loadAll && this._options.files.length > 0) {
  ...
  async loadLocale(e) {
    ...
    this._dicts[e] = t.json ? await F.load(t.json) : await ie(t);
  }
  getCoreFunctions() {
    return ["t", "setLocale"];
  }
...
class $s extends E {
  ...
  resize() {
    ...
    const s = (x = this.app.renderer.canvas) == null ? void 0 : x.parentElement, n = s == null ? void 0 : s.getBoundingClientRect();
    n && (e = n.width, t = n.height);
    const o = this._options.minSize.width, r = this._options.minSize.height, a = e < o ? o / e : 1, h = t < r ? r / t : 1, u = a > h ? a : h, c = e * u, _ = t * u;
    this.app.renderer.canvas.style.width = `${e}px`, this.app.renderer.canvas.style.height = `${t}px`, this._options.autoScroll && (window == null || window.scrollTo(0, 0)), this.app.renderer.resize(c, _), this._size = { width: c, height: _ }, this._options.debug && this._drawDebug();
  }
  /**
   * Draws debug information if debug option is enabled.
   */
  _drawDebug() {
    this._debugContainer || (this._debugContainer = this.app.stage.addChild(new j()), this._gfx = this._debugContainer.add.graphics()), this._gfx.clear(), this._gfx.rect(0, 0, this._size.width, this._size.height), this._gfx.stroke({ width: 4, color: 4095 });
  }
}
const Ne = [
  {
...
}, U = class U extends qe {
  constructor() {
    super(), this.__dill_pixel_method_binding_root = !0, this.onPause = new l(), this.onResume = new l(), this.onResize = new l(), this._plugins = /* @__PURE__ */ new Map(), this._center = new L(0, 0), b(this);
  }
  get appVersion() {
    try {
  ...
  async initialize(e) {
    ...
    if (U.instance = this, this.config = Object.assign({ ...Rs }, e), await this.boot(this.config), await this.preInitialize(this.config), await this.initAssets(), await this.init(this.config), f.initialize(e.id), await this.registerDefaultPlugins(), this.config.plugins && this.config.plugins.length > 0)
    ...
    if (await this.registerPlugins(), this.config.useStore) {
      if (this._store = new Kt(), this._store.initialize(this), this.config.storageAdapters && this.config.storageAdapters.length > 0)
    ...
    return await this._setup(), await this.setup(), await this.loadDefaultScene(), this.renderer.canvas.focus(), this.config.container && this.config.container.classList.add("loaded"), U.instance;
  }
  getPlugin(e) {
  ...
  async loadPlugin(e) {
    ...
    const t = await ie(e), s = new t(e.id);
    return s.id !== e.id && (s.id = e.id), await this.registerPlugin(s, e.options);
  }
  sendAction(e, t) {
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  async boot(e) {
    f.log(`${this.appName}:: v${this.appVersion}`);
  }
  /**
  ...
  async registerPlugin(e, t) {
    return this._plugins.has(e.id) ? (f.error(`Plugin with id "${e.id}" already registered. Not registering.`), e.initialize(this, t)) : (f.log(`Registering plugin: ${e.id}`), e.registerCoreFunctions(), e.registerCoreSignals(), this._plugins.set(e.id, e), e.initialize(this, t));
  }
  ...
  async initAssets() {
    ...
    if (this.config.manifest) {
      ...
      st(t) && (t = await t), e.manifest = t;
    }
    this.manifest = e.manifest, await F.init(e);
  }
  async loadDefaultScene() {
...
U.containerId = "dill-pixel-game-container";
let v = U;
const oi = T.Collector, ri = T.CollectorArray, ai = T.CollectorLast, hi = T.CollectorUntil0, li = T.CollectorWhile0, ui = T.SignalConnections;
export {
  w as Action,
  ot as ActionContext,
  as as Animated,
  ...
  ds as Button,
  We as ButtonConfigKeys,
  ii as Camera,
  ni as CameraController,
  oi as Collector,
  ri as CollectorArray,
  ai as CollectorLast,
  hi as CollectorUntil0,
  li as CollectorWhile0,
  j as Container,
  ne as FlexContainer,
  He as FlexContainerConfigKeys,
  rs as FocusManagerPlugin,
  ns as FocusOutliner,
  rt as Focusable,
  R as InputController,
  ss as InputPlugin,
  hs as Interactive,
  is as KeyboardPlugin,
  Js as LocalStorageAdapter,
  f as Logger,
  Gs as PIXI,
  E as Plugin,
  H as Popup,
  ws as PopupManagerPlugin,
  jt as Queue,
  $s as ResizerPlugin,
  si as Scene,
  es as SceneManagerPlugin,
  l as Signal,
  ...
  Xs as clamp,
  Se as coreFunctionRegistry,
  nt as coreSignalRegistry,
  Zs as create,
