import { Point as T, isMobile as Qe, Assets as p, Container as X, Graphics as Ae, Texture as gt, Sprite as ke, Text as mt, BitmapText as vt, Rectangle as Ue, EventEmitter as Y, Ticker as V, DOMAdapter as yt, path as te, ExtensionType as Be, LoaderParserPriority as wt, extensions as bt, Application as xt } from "pixi.js";
...
const Ze = process.env.NODE_ENV, W = Ze === "development", Vs = Ze === "production";
function xe(i) {
...
const nt = {
  existing: (i, e) => {
    ...
    return S({ position: t, x: s, y: n }, i), A({ scale: r, scaleX: a, scaleY: h }, i), k(o, i), P(u, i), i;
  },
  texture: Ge,
  container: (i) => {
    const e = new $();
    ...
    return S({ position: t, x: s, y: n }, e), A({ scale: r, scaleX: a, scaleY: h }, e), k(o, e), P(u, e), e;
  },
  sprite: (i) => {
    ...
    return S({ position: t, x: s, y: n }, e), A({ scale: a, scaleX: h, scaleY: u }, e), be(o, e), k(r, e), P(c, e), e;
  },
  graphics: (i) => {
    const e = new Ae();
    if (!i)
  ...
  text: (i) => {
    ...
    S({ position: s, x: n, y: o }, t), A({ scale: r, scaleX: a, scaleY: h }, t), k(u, t);
    const c = j(
  ...
  bitmapText: (i) => {
    ...
    i != null && i.position && S({ position: i.position, x: i.x, y: i.y }, t), i != null && i.scale && A({ scale: i.scale ?? 1, scaleX: i.scaleX, scaleY: i.scaleY }, t), i != null && i.pivot && k(i.pivot, t);
    const s = j(
      ["x", "y", "position", "text", "roundPixels", "resolution", "style", "anchor", "pivot"],
      i ?? {}
    );
  ...
  button: (i) => {
    ...
    return S({ position: n, x: o, y: r }, s), A({ scale: h, scaleX: u, scaleY: c }, s), k(a, s), P(d, s), s;
  },
  flexContainer: (i) => {
  ...
  spine: (i) => {
    ...
    return S({ position: s, x: n, y: o }, t), A({ scale: h, scaleX: u, scaleY: c }, t), be(r, t), k(a, t), P(d, t), t;
  },
  spineAnimation: (i) => {
    const e = new ys(i);
    if (!i)
...
const He = ["textures", "cursor", "disabledCursor", "sheet", "enabled"], cs = it(hs(N(q())));
class ds extends cs {
  /**
   * @constructor
  ...
  handlePointerUpOutside() {
    this._enabled && (window.removeEventListener("pointerup", this.handlePointerUpOutside), this.off("pointerupoutside", this.handlePointerUpOutside), this.view.texture = this.make.texture({ asset: this.config.textures.default, sheet: this.config.sheet }), this.isDown = !1, this.isOver = !1, this.onUpOutside.emit());
  }
