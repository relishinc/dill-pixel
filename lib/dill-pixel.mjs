import { Point as F, isMobile as Qe, Container as K, Graphics as Ae, Texture as gt, Assets as T, Sprite as ke, Text as mt, BitmapText as vt, Rectangle as Ue, EventEmitter as X, Ticker as V, DOMAdapter as yt, path as ee, ExtensionType as $e, LoaderParserPriority as wt, extensions as bt, Application as xt } from "pixi.js";
...
ue.CollectorUntil0 = Mt;
var ce = {};
Object.defineProperty(ce, "__esModule", { value: !0 });
ce.CollectorWhile0 = void 0;
const Lt = D;
class Ft extends Lt.Collector {
  constructor() {
    super(...arguments), this.result = !1;
  }
  handleResult(e) {
...
let Ot = class {
  constructor() {
    this.head = new zt.SignalLink(), this.hasNewLinks = !1, this.emitDepth = 0, this.connectionsCount = 0;
  }
  /**
...
const ye = {
  ...
  constructor(e) {
    g._instance = this, g.mode = e !== void 0 ? e : te ? "development" : "default", ["development", "default", "disabled"].includes(g.mode) || (g.mode = "default");
  }
  static get mode() {
    return g._mode;
  }
  ...
  static trace(e = "log", ...t) {
    if (g.mode !== "disabled") {
      if (g.mode === "default")
        return console.log(`%c[ Logger:: ${xe(e)} ]`, ye[e], ...t);
      console.groupCollapsed(`%c Logger:: ${xe(e)} `, ye[e], ...t), console.trace("%c Stack ", ye[e]), console.groupEnd();
    }
  }
};
g._instance = null, g._mode = "disabled";
let _ = g;
  ...
  async save(e, t, s, n = !0) {
    ...
    for (let h = 0; h < o.length; h++) {
      ...
      if (typeof o[h] == "object") {
        ...
        u = o[h], c = n;
      const f = this._adapters.get(u);
      if (!f)
        throw new Error(`Adapter ${o[h]} not found`);
      c ? r.push(await f.save(t, s)) : r.push(void f.save(t, s));
    }
    return r;
  }
  /**
...
async function Qs(i, e = { id: "DillPixelApplication" }, t = Yt, s = !0) {
  s && Xt();
  let n = null;
...
class E {
  constructor(e = "Plugin") {
    this.id = e, this._signalConnections = new L.SignalConnections(), b(this), this.__dill_pixel_method_binding_root = !0;
  }
  get app() {
...
class Jt extends E {
  constructor() {
    super(), this.id = "scenes", this.onSceneChangeStart = new l(), this.onSceneChangeComplete = new l(), this.view = new K(), this.isFirstScene = !0, this.scenes = [], this._sceneModules = /* @__PURE__ */ new Map(), this._lastScene = null, this._defaultLoadMethod = "immediate", this._debugVisible = !1, b(this);
  }
  ...
  _createDebugMenu() {
    ...
    e.style.cssText = "cursor:pointer; position:absolute;width:100%; font-style:normal; font-size:20px; top:50%; left:50%; transform:translate(-50%, -50%); text-align:center; pointer-events:none", e.innerHTML = "🎬", this._debugMenu.appendChild(e), (p.containerElement || document.body).appendChild(this._debugMenu), this._sceneSelect = document.createElement("select"), this._sceneSelect.style.cssText = "padding:0; border-radius:5px; opacity:0; width:48px; height:48px; cursor:pointer", this._sceneSelect.value = this.defaultScene || "";
...
class ts extends E {
  ...
  _onGamepadDisconnected(e) {
    this._deactivateGamepad(e.gamepad.id), this.sendAction(w.Pause), this.onGamepadDisconnected.emit(e.gamepad), this.activeGamepads.size === 0 && this._deactivateController(U.Gamepad);
  }
}
class ss extends E {
  constructor() {
...
class is extends K {
  ...
  setFocusTarget(e) {
    e && (this.focusTarget = e, this.focusBounds = this.focusTarget.getFocusArea().clone(), p.getInstance().ticker.add(this.updatePosition));
  }
  clearFocusTarget() {
    this.focusTarget = null, p.getInstance().ticker.remove(this.updatePosition);
  }
  updatePosition() {
    if (!this.focusTarget)
      return;
...
function Y(i) {
  return class extends i {
    constructor() {
      super(...arguments), this.signalConnections = new L.SignalConnections();
    }
    /**
     * Add signal connections to the container.
     * @param args - The signal connections to add.
...
function P(i, e) {
  const t = z(i.position, !1, i.x, i.y);
  e.x = t.x, e.y = t.y;
}
function S(i, e) {
  if (!i)
  ...
  const t = z(i.scale, !1, i.scaleX, i.scaleY);
  e.scale.set(t.x, t.y);
}
function be(i, e) {
  if (i !== void 0) {
...
const nt = {
  ...
  sprite: (i) => {
    ...
    return P({ position: t, x: s, y: n }, e), S({ scale: a, scaleX: h, scaleY: u }, e), be(o, e), A(r, e), C(c, e), e;
  },
  graphics: (i) => {
    const e = new Ae();
    if (!i)
  ...
  text: (i) => {
    const e = i ? {
      ...
      style: i.style,
      anchor: i.anchor ? z(i.anchor, !0) : void 0
    } : {}, t = new mt(e);
    if (!i)
      return t;
  ...
  button: (i) => {
    ...
    if (!t)
      return s;
    const { position: n, x: o, y: r, pivot: a, scale: h, scaleX: u, scaleY: c, ...f } = t;
    return P({ position: n, x: o, y: r }, s), S({ scale: h, scaleX: u, scaleY: c }, s), A(a, s), C(f, s), s;
  },
  flexContainer: (i) => {
  ...
  spine: (i) => {
    ...
    const { position: s, x: n, y: o, anchor: r, pivot: a, scale: h, scaleX: u, scaleY: c, ...f } = i;
    return P({ position: s, x: n, y: o }, t), S({ scale: h, scaleX: u, scaleY: c }, t), be(r, t), A(a, t), C(f, t), t;
  },
  spineAnimation: (i) => {
    const e = new vs(i);
    if (!i)
...
class si extends K {
  ...
  focusOn(e) {
    ...
    const c = this.viewportHeight / this.scale.y / 2 + o + this.minY - a, f = this.worldHeight - this.viewportHeight / this.scale.y / 2 + o + this.maxY - a;
    this._targetPivot.y < c ? this._targetPivot.y = c : this._targetPivot.y > f && (this._targetPivot.y = f);
  }
  updateZoom() {
...
class ii {
  ...
  getEventPosition(e) {
    return e instanceof TouchEvent ? new F(e.touches[0].clientX, e.touches[0].clientY) : new F(e.clientX, e.clientY);
  }
}
const ds = Y(N()), Ke = [
  "width",
...
class ie extends ds {
  constructor(e = {}) {
    ...
    }, b(this), this.config = Object.assign({ ...fs }, e), this.on("added", this._added), this.on("childAdded", this.handleChildAdded), this.on("childRemoved", this.handleChildRemoved), this.layout();
  }
  get flexChildren() {
  ...
  _layout() {
    ...
    let u = [], c = 0, f = 0, x = 0, q = 0, Le = 0, Fe = 0;
    const R = [], ge = this.children.filter(Boolean);
    let Q = [], me = 0;
    const ut = (d, y, m) => o === "row" && y + d.width + n > t || o === "column" && m + d.height + n > s, ct = () => {
      o === "row" ? Le += x + n : Fe += q + n, c = 0, f = 0, x = 0, q = 0;
    }, dt = (d) => {
      o === "row" ? (c += d.width + n, x = Math.max(x, d.height)) : (f += d.height + n, q = Math.max(q, d.width));
    }, ft = (d) => o === "row" ? d : Fe, _t = (d) => o === "column" ? d : Le, Te = (d, y, m, I) => {
      const v = (I === "row" ? t : s) - (m - y);
      d.forEach(({ index: Ie }, ve) => {
        let O = 0;
        switch (h) {
          case "flex-start":
            break;
          ...
          case "center":
            ...
            break;
          case "space-between":
            O = d.length > 1 ? ve * (v / (d.length - 1)) : 0;
            break;
          case "space-around":
            O = v / d.length * ve + v / (2 * d.length);
            break;
          case "space-evenly":
            O = v / (d.length + 1) * (ve + 1);
            break;
    ...
    ge.forEach((d, y) => {
      if (!d)
        return;
      const m = d;
      r === "wrap" && ut(m, c, f) && (Te(Q, me, o === "column" ? f - n : c - n, o), ct(), Q = [], me = c), Q.push({ index: y, width: m.width, height: m.height }), R[y] = { x: ft(c), y: _t(f) }, dt(m);
    }), Te(Q, me, o === "column" ? f - n : c - n, o), pt(R, ge), u = R, ge.forEach((d, y) => {
      const m = d, { x: I, y: v } = u[y] || { x: 0, y: 0 };
      m.position.set(I, v);
    });
    const De = this.children.reduce((d, y) => Math.max(d, y.y + y.height), 0);
...
class ne extends _s {
  constructor(e) {
    super(), this.settingsMap = /* @__PURE__ */ new Map(), this._childMap = /* @__PURE__ */ new Map(), this._reparentAddedChild = !0, this._disableAddChildError = !1, this._canvasChildren = [], this.removeChildren = (t, s) => this._inner.removeChildren(t, s), this.removeChildAt = (t) => this._inner.removeChildAt(t), this.addChildAt = (t, s) => {
      ...
      size: e.size !== void 0 ? Be(e.size) : { width: 0, height: 0 },
  ...
  set size(e) {
    this.config.useAppSize = !1, this.config.size = e === void 0 ? { width: 0, height: 0 } : Be(e), this.resize();
  }
  set padding(e) {
...
class G extends B {
  ...
  static makeBacking(e, t) {
    ...
    if (G.BACKING_TEXTURE === void 0) {
      const a = new Ae();
      a.rect(0, 0, 100, 100).fill("white"), G.BACKING_TEXTURE = p.getInstance().renderer.generateTexture(a);
    }
    const o = new B();
...
class ys extends E {
  constructor() {
    super(...arguments), this.id = "popups", this.view = new B(), this.onShowPopup = new l(), this.onHidePopup = new l(), this._popups = /* @__PURE__ */ new Map(), this._activePopups = /* @__PURE__ */ new Map(), this._currentPopupId = void 0;
  }
...
const $ = class {
  ...
  static from(i) {
    ...
    const t = W().useLegacy ? new Ps() : new Ls();
    return new $(t, e);
  }
  /**
   * Use `Sound.from`
...
class Ds extends E {
  ...
  async play(e, t = "sfx", s) {
    ...
    if (n) {
      ...
      const o = n.add(e, new Ye(e, n, this)), r = await k.play(e, s);
...
class Os extends E {
   ...
   */
  async initialize(e, t) {
    if (super.initialize(e), this._options = { ...zs, ...t }, this._locale = this._options.defaultLocale, this._options.loadAll && this._options.files.length > 0) {
  ...
  async loadLocale(e) {
    ...
    this._dicts[e] = t.json ? await T.load(t.json) : await se(t);
  }
  getCoreFunctions() {
    return ["t", "setLocale"];
  }
...
class Us extends E {
  ...
  resize() {
    ...
    const o = this._options.minSize.width, r = this._options.minSize.height, a = e < o ? o / e : 1, h = t < r ? r / t : 1, u = a > h ? a : h, c = e * u, f = t * u;
    this.app.renderer.canvas.style.width = `${e}px`, this.app.renderer.canvas.style.height = `${t}px`, this._options.autoScroll && (window == null || window.scrollTo(0, 0)), this.app.renderer.resize(c, f), this._size = { width: c, height: f }, this._options.debug && this._drawDebug();
  }
  /**
...
class p extends xt {
  constructor() {
    super(), this.__dill_pixel_method_binding_root = !0, this.onPause = new l(), this.onResume = new l(), this.onResize = new l(), this._plugins = /* @__PURE__ */ new Map(), this._center = new F(0, 0), b(this);
  }
  get appVersion() {
    try {
  ...
  setContainer(e) {
    p.containerElement || (p.containerElement = e);
  }
  async initialize(e) {
    if (p.instance)
      throw new Error("Application is already initialized");
    if (p.instance = this, this.config = Object.assign({ ...$s }, e), e.container && (p.containerElement = e.container), _.initialize(this.config.logger), await this.boot(this.config), await this.preInitialize(this.config), await this.initAssets(), await this.init(this.config), await this.registerDefaultPlugins(), this.config.plugins && this.config.plugins.length > 0)
    ...
    return await this._setup(), await this.setup(), await this.loadDefaultScene(), this.renderer.canvas.focus(), this.config.container && this.config.container.classList.add("loaded"), p.instance;
  }
  getPlugin(e) {
  ...
  async loadPlugin(e) {
    ...
    const t = await se(e), s = new t(e.id);
  ...
  async initAssets() {
    ...
    this.manifest = e.manifest, await T.init(e);
  }
  async loadDefaultScene() {
...
const ni = L.Collector, oi = L.CollectorArray, ri = L.CollectorLast, ai = L.CollectorUntil0, hi = L.CollectorWhile0, li = L.SignalConnections;
export {
  w as Action,
  st as ActionContext,
  rs as Animated,
  ...
  Z as pluck,
  J as resolvePadding,
  z as resolvePointLike,
  Be as resolveSizeLike,
  Xt as sayHello,
  Ws as setObjectName,
  Ht as version
};
