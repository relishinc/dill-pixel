import { Point as T, isMobile as Ze, Assets as p, Container as Y, Graphics as ke, Texture as mt, Sprite as Le, Text as vt, BitmapText as yt, Rectangle as Be, EventEmitter as N, Ticker as W, DOMAdapter as wt, path as se, ExtensionType as $e, LoaderParserPriority as bt, extensions as xt, Application as Ct } from "pixi.js";
...
le.CollectorArray = void 0;
const St = z;
class At extends St.Collector {
  constructor() {
...
le.CollectorArray = At;
var ue = {};
Object.defineProperty(ue, "__esModule", { value: !0 });
ue.CollectorLast = void 0;
const kt = z;
class Lt extends kt.Collector {
  handleResult(e) {
...
ce.CollectorUntil0 = void 0;
const Et = z;
class Mt extends Et.Collector {
  constructor() {
...
ce.CollectorUntil0 = Mt;
var de = {};
Object.defineProperty(de, "__esModule", { value: !0 });
de.CollectorWhile0 = void 0;
const Ft = z;
class Tt extends Ft.Collector {
  constructor() {
    super(...arguments), this.result = !1;
  }
  handleResult(e) {
...
de.CollectorWhile0 = Tt;
var fe = {}, _e = {};
Object.defineProperty(_e, "__esModule", { value: !0 });
_e.SignalConnectionImpl = void 0;
class zt {
  /**
...
_e.SignalConnectionImpl = zt;
var pe = {};
Object.defineProperty(pe, "__esModule", { value: !0 });
pe.SignalLink = void 0;
class Ee {
...
let Ut = class {
  constructor() {
    this.head = new Ot.SignalLink(), this.hasNewLinks = !1, this.emitDepth = 0, this.connectionsCount = 0;
  }
  /**
  ...
  connect(e, t = 0) {
    ...
    return this.emitDepth > 0 && (this.hasNewLinks = !0, s.newLink = !0), new Dt.SignalConnectionImpl(s, () => this.decrementConnectionCount());
  }
...
const Je = process.env.NODE_ENV, H = Je === "development", Hs = Je === "production";
function Ce(i) {
  return i.charAt(0).toUpperCase() + i.slice(1);
}
function Ks(i) {
  return i.split(" ").map(Ce).join(" ");
}
const we = {
  ...
  constructor(e) {
    m._instance = this, m.mode = e !== void 0 ? e : H ? "development" : "default", ["development", "default", "disabled"].includes(m.mode) || (m.mode = "default");
  }
  static get mode() {
    return m._mode;
  }
  ...
  static trace(e = "log", ...t) {
    if (m.mode !== "disabled") {
      if (m.mode === "default")
        return console.log(`%c ${Ce(e)} `, we[e], ...t);
      console.groupCollapsed(`%c ${Ce(e)} `, we[e], ...t), console.trace("%c Stack ", we[e]), console.groupEnd();
    }
  }
};
m._instance = null, m._mode = "disabled";
let f = m;
const Bt = (i = 0) => new Promise((e) => setTimeout(e, i * 1e3)), et = (i) => i && typeof i.then == "function";
function $t(...i) {
  return new Rt(i);
}
class Rt {
  ...
  async _next() {
    ...
    try {
      ...
      f.error("Queue didn't complete due to an error:", t, "Cancelling Queue"), this._isCanceled = !0;
    }
  }
}
function jt(i) {
...
async function ie(i) {
  let e, t;
  return et(i.module) ? (e = await i.module, t = i != null && i.namedExport ? e[i.namedExport] : e.default) : typeof i.module == "function" ? jt(i.module) ? (e = i.module, t = e) : (e = await i.module(), t = i != null && i.namedExport ? e[i.namedExport] : e.default) : (e = i.module, t = e), t;
}
...
function Xs(i, e, t) {
  t && e ? i.name = `${Vt(t)}/${e}` : typeof e == "string" && (i.name = `${e}`), typeof e == "string" && (i.__textureString = e), Array.isArray(t) ? i.__textureSheetArray = t : t && (i.__textureSheet = t);
}
function Ys(i, e) {
  let t;
  return function(...s) {
...
const Zs = window.devicePixelRatio > 1 || window.matchMedia && window.matchMedia(
...
class Ht {
  ...
  async registerAdapter(e, t) {
    if (this._adapters.has(e.id))
      return f.error(`Storage Adapter with id "${e.id}" already registered. Not registering.`), Promise.resolve();
...
const st = {}, Pe = {}, Kt = "8.7.0", Xt = "8.1.5";
function Yt() {
  const i = `%c Dill Pixel Game Framework v${Kt} | %cPixi.js v${Xt} %c| %chttps://dillpixel.io `;
  console.log(
    i,
...
const Nt = "dill-pixel-game-container";
function qt(i) {
  const e = document.createElement("div");
  return e.setAttribute("id", i), document.body.appendChild(e), e;
}
async function ei(i = { id: "DillPixelApplication" }, e = g, t = Nt, s = !0) {
  s && Yt();
  let n = null;
  if (typeof t == "string" ? (n = document.getElementById(t), n || (n = qt(t))) : t instanceof HTMLElement ? n = t : t === window && (n = document.body), !n)
    throw new Error(
  ...
  return await Bt(0.01), await o.postInitialize(), o;
}
class M {
  constructor(e = "Plugin") {
    this.id = e, this._signalConnections = new F.SignalConnections(), P(this), this.__dill_pixel_method_binding_root = !0;
  }
  get app() {
...
class ti extends Qt {
   ...
   */
  initialize(e, t) {
    f.log("LocalStorageAdapter initialized"), this.namespace = (t == null ? void 0 : t.namespace) || "";
  }
  /**
...
}, Jt = ["png", "jpg", "jpeg", "webp", "gif", "avif", "svg"];
function I(i) {
  return Array.isArray(i) || (i = [i]), i.map((e) => {
    var t, s;
    if (typeof e == "string")
      return e;
    if (typeof e == "object") {
      let n = (e == null ? void 0 : e.src) || [];
      return Array.isArray(n) || (n = [n]), e.ext && (e.src && !Array.isArray(e.src) && (n.push(e.src), Jt.includes(e.ext) && ((t = e == null ? void 0 : e.src) == null ? void 0 : t.indexOf("@1x")) === -1 && ((s = e == null ? void 0 : e.src) == null ? void 0 : s.indexOf("0.5x")) === -1 ? e.src = [`${e.src}@0.5x`, `${e.src}@1x`, e.src] : e.src = [e.src]), e.src = e.src.map((o) => `${o}.${e.ext}`), e.alias = [...n, ...e.src].filter(Boolean)), e;
    }
  });
}
class es extends M {
  constructor() {
    super(...arguments), this.id = "assets", this.onLoadStart = new l(), this.onLoadProgress = new l(), this.onLoadComplete = new l(), this._loadedBundles = /* @__PURE__ */ new Set(), this._loadedAssets = /* @__PURE__ */ new Set(), this._required = {}, this._background = {};
  }
  initialize(e, t) {
    t != null && t.preload && (this._required = t.preload), t != null && t.background && (this._background = t.background), p.setPreferences({ ...Zt, ...t == null ? void 0 : t.assetPreferences }), f.log("AssetsPlugin initialized", e, t, this._required);
  }
  async loadRequired() {
    return this._handleLoadStart(), this._handleLoadProgress(0), this._required && (this._required.assets && await p.load(I(this._required.assets), this._handleLoadProgress), this._required.bundles && await p.loadBundle(this._required.bundles, this._handleLoadProgress)), this._handleLoadComplete(), Promise.resolve();
  }
  loadBackground() {
    this._background && (this._background.assets && I(this._background.assets).forEach((e) => {
      if (e != null && e.src) {
        const t = e.src;
        if (t)
          return p.backgroundLoad(t);
      }
      return p.backgroundLoad(e);
    }), this._background.bundles && p.backgroundLoadBundle(this._background.bundles));
  }
  async loadAssets(e) {
    return e = I(e), await p.load(e, this._handleLoadProgress), this._markAssetsLoaded(e), Promise.resolve();
  }
  async loadBundles(e) {
    return await p.loadBundle(e, this._handleLoadProgress), this._markBundlesLoaded(e), Promise.resolve();
  }
  async unloadSceneAssets(e) {
    var t, s, n, o;
    if ((s = (t = e.assets) == null ? void 0 : t.preload) != null && s.assets) {
      const r = I(e.assets.preload.assets);
      p.unload(r).then(() => {
        this._markAssetsUnloaded(r);
      });
    }
    if ((o = (n = e.assets) == null ? void 0 : n.preload) != null && o.bundles) {
      const r = e.assets.preload.bundles;
      p.unloadBundle(r).then(() => {
  ...
  async loadSceneAssets(e, t = !1) {
    var s, n, o, r, a;
    if (t) {
      if ((s = e.assets) != null && s.background) {
        if (e.assets.background.assets) {
          const u = I(e.assets.background.assets).filter((c) => !this._isAssetLoaded(c));
          u.length && u.forEach((c) => {
            if (c != null && c.src) {
              const d = c.src;
              if (d)
                return p.backgroundLoad(d);
            }
            return p.backgroundLoad(c);
          });
        }
        if (e.assets.background.bundles) {
          let h = Array.isArray(e.assets.background.bundles) ? e.assets.background.bundles : [e.assets.background.bundles];
          h = h.filter((u) => !this._isBundleLoaded(u)), h.length && p.backgroundLoadBundle(h);
        }
      }
    } else {
      if (this._handleLoadStart(), this._handleLoadProgress(0), (o = (n = e.assets) == null ? void 0 : n.preload) != null && o.assets) {
        const h = I(e.assets.preload.assets), u = h.filter((c) => !this._isAssetLoaded(c));
        f.log("filteredAssets", u), u.length && (await p.load(u, this._handleLoadProgress), this._markAssetsLoaded(h));
      }
      if ((a = (r = e.assets) == null ? void 0 : r.preload) != null && a.bundles) {
        let h = Array.isArray(e.assets.preload.bundles) ? e.assets.preload.bundles : [e.assets.preload.bundles];
        h = h.filter((u) => !this._isBundleLoaded(u)), h.length && (await p.loadBundle(h, this._handleLoadProgress), this._markBundlesLoaded(h));
      }
  ...
  _isAssetLoaded(e) {
    return this._loadedAssets.has(e);
  }
  _isBundleLoaded(e) {
    return this._loadedBundles.has(e);
  }
  _markAssetsLoaded(e) {
    e.forEach((t) => {
      this._loadedAssets.add(t);
    });
  }
  _markBundlesLoaded(e) {
    Array.isArray(e) || (e = [e]), e.forEach((t) => {
      this._loadedBundles.add(t);
    });
  }
  _markAssetsUnloaded(e) {
    Array.isArray(e) || (e = [e]), e.forEach((t) => {
      this._loadedAssets.delete(t);
    });
  }
  _markBundlesUnloaded(e) {
    Array.isArray(e) || (e = [e]), e.forEach((t) => {
      this._loadedBundles.delete(t);
    });
  }
  _handleLoadStart() {
    f.log("AssetsPlugin:: onLoadStart"), this.onLoadStart.emit();
  }
  _handleLoadProgress(e) {
    f.log("AssetsPlugin:: onLoadProgress", e), this.onLoadProgress.emit(e);
  }
  _handleLoadComplete() {
    this._handleLoadProgress(1), f.log("AssetsPlugin:: onLoadComplete"), this.onLoadComplete.emit();
  }
}
class ts extends M {
  /**
   ...
   */
  constructor() {
    super(), this.id = "webEvents", this.onResize = new l(), this.onVisibilityChanged = new l(), P(this);
  }
  get app() {
    return g.getInstance();
  }
  initialize() {
    document.addEventListener("visibilitychange", this._onVisibilityChanged, !1), window.addEventListener("pagehide", this._onPageHide, !1), window.addEventListener("pageshow", this._onPageShow, !1), window.addEventListener("resize", this._onResize), document.addEventListener("fullscreenchange", this._onResize);
  }
  destroy() {
    document.removeEventListener("visibilitychange", this._onVisibilityChanged, !1), window.removeEventListener("resize", this._onResize), document.removeEventListener("fullscreenchange", this._onResize), window.removeEventListener("pagehide", this._onPageHide, !1), window.removeEventListener("pageshow", this._onPageShow, !1);
  }
  getCoreSignals() {
   ...
   */
  _onPageHide() {
    this.onVisibilityChanged.emit(!1);
  }
  /**
   ...
   */
  _onPageShow() {
    this.onVisibilityChanged.emit(!0);
  }
}
class ss extends M {
  constructor() {
  ...
  initialize(e) {
    var t, s, n, o, r, a;
    return this._debugVisible = ((t = this.app.config) == null ? void 0 : t.showSceneDebugMenu) === !0 || H && ((s = this.app.config) == null ? void 0 : s.showSceneDebugMenu) !== !1, this.view.sortableChildren = !0, this.scenes = ((n = e.config) == null ? void 0 : n.scenes) || [], this._debugVisible && (this.defaultScene = this._getSceneFromHash() || ""), this.defaultScene = this.defaultScene || ((o = e.config) == null ? void 0 : o.defaultScene) || ((a = (r = this.scenes) == null ? void 0 : r[0]) == null ? void 0 : a.id), this._defaultLoadMethod = e.config.defaultSceneLoadMethod || "immediate", f.log("SceneManager initialize::", this.scenes), this._debugVisible && this._createDebugMenu(), Promise.resolve(void 0);
  }
  ...
  async loadScene(e) {
    ...
    switch (this._currentSceneId = t, this._queue = $t(this._createCurrentScene), s) {
      case "exitEnter":
        this._queue.add(
          this._exitLastScene,
...
class ns extends M {
  ...
  async initialize(e, t = Ve) {
    this.options = { ...Ve, ...t }, e.stage.eventMode = "static", e.stage.on("touchstart", this._onTouchStart), e.stage.on("globalmousemove", this._onMouseMove), window.addEventListener("keydown", this._onKeyDown), window.addEventListener("gamepadconnected", this._onGamepadConnected), window.addEventListener("gamepaddisconnected", this._onGamepadDisconnected);
  }
  destroy() {
...
class rs extends Y {
  constructor(e) {
    super(), P(this), this._config = {
      color: 65535,
      shape: "rounded rectangle",
      radius: 8,
      lineWidth: 2,
      ...e
    }, this._graphics = new ke(), this.addChild(this._graphics);
  }
  draw(e) {
...
class hs extends M {
  ...
  initialize(e) {
    ...
    t.usePixiAccessibility = t.usePixiAccessibility ?? !1, this._focusOutliner = typeof (t == null ? void 0 : t.outliner) == "function" ? new t.outliner() : new rs(t.outliner), this._options = t, this.view.addChild(this._focusOutliner), this._updatePixiAccessibility(), this._setupKeyboardListeners(), this._setupAppListeners();
  }
  destroy() {
  ...
  addFocusable(e, t, s = !1) {
    ...
    if (!n) {
      f.error(`Layer with ID ${t} does not exist.`);
      return;
    }
  ...
  addFocusLayer(e, t = !0, s) {
    ...
    let n;
    return this._layers.has(e) ? (f.error(`Layer with ID ${e} already exists.`), n = this._layers.get(e)) : (n = new as(e), this._layers.set(e, n)), (t || this._currentLayerId === null) && this.setFocusLayer(e), s && this.addFocusable(s, e), n;
  }
  removeFocusLayer(e, t = !0) {
    ...
    const s = (n = je(this._layers, e)) == null ? void 0 : n[0];
  ...
  _next() {
    ...
    if (!e) {
      f.error("FocusManager:: _next():: No focusable found in the current layer.");
      return;
    }
    this._setTarget(e);
  }
  _prev() {
    ...
    if (!e) {
      f.error("FocusManager:: _prev():: No focusable found in the current layer.");
      return;
    }
    this._setTarget(e);
  }
  ...
  _removeTopLayer() {
    var s, n;
    const e = (s = tt(this._layers)) == null ? void 0 : s[0], t = (n = je(this._layers, e)) == null ? void 0 : n[0];
  ...
  _setTarget(e, t = !0) {
    ...
    if (this._focusTarget = e, n && this._active && this._clearFocusTarget(n), this.app.renderer.accessibility.isActive || this._keyboardActive)
      ...
      }), s != null && s.hasFocusable(e) ? this._focusTarget && (this._focusTarget.focusIn(), this._focusTarget.isFocused = !0, this._focusTarget.onFocusIn.emit(this._focusTarget), s.setCurrentFocusable(this._focusTarget), this._updateOutliner()) : f.warn(
        "The focusable",
        e,
...
function ls(i) {
  return class extends i {
    ...
    animateSequence(e, t = this) {
      return this._activeTimeline || (this._activeTimeline = E.timeline({
     ...
     */
    shake(e = {}, t = this) {
      const { duration: s = 0.05, intensity: n = 12, times: o = 41 } = e, a = { x: t.x, y: t.y }.x, h = o % 2 === 0 ? o + 1 : o, u = E.to(t, {
        x: a + E.utils.random(-Math.max(n, 2), Math.max(n, 2)),
        repeat: h,
        yoyo: !0,
        duration: s
      });
     ...
     */
    pulse(e = {}, t = this) {
      const { duration: s = 0.5, intensity: n = 1.2, times: o = 1 } = e, r = o * 2 - 1, a = E.to(t == null ? void 0 : t.scale, {
        x: n,
        y: n,
        repeat: r,
        yoyo: !0,
     ...
     */
    bob(e = {}, t = this) {
      const { duration: s = 0.5, intensity: n = 10 } = e, o = E.to(t, {
        y: `-=${n}`,
        repeat: -1,
        yoyo: !0,
        duration: s
...
const cs = ["text", "anchor", "resolution", "roundPixels", "style"];
function S(i, e) {
  for (const t in i)
    try {
      e[t] = i[t];
    } catch (s) {
      f.error(`Error setting property ${t}`, s);
    }
}
function Ge(i) {
  let e;
...
const ot = {
  existing: (i, e) => {
    ...
    return A({ position: t, x: s, y: n }, i), k({ scale: r, scaleX: a, scaleY: h }, i), L(o, i), S(u, i), i;
  },
  texture: Ge,
  container: (i) => {
    const e = new R();
    ...
    return A({ position: t, x: s, y: n }, e), k({ scale: r, scaleX: a, scaleY: h }, e), L(o, e), S(u, e), e;
  },
  sprite: (i) => {
    const e = new Le(i ? Ge(i) : void 0);
    if (!i)
      return e;
    const { position: t, x: s, y: n, anchor: o, pivot: r, scale: a, scaleX: h, scaleY: u, ...c } = i;
    return A({ position: t, x: s, y: n }, e), k({ scale: a, scaleX: h, scaleY: u }, e), xe(o, e), L(r, e), S(c, e), e;
  },
  graphics: (i) => {
    const e = new ke();
    if (!i)
  ...
  text: (i) => {
    ...
    A({ position: s, x: n, y: o }, t), k({ scale: r, scaleX: a, scaleY: h }, t), L(u, t);
    const c = V(
  ...
  bitmapText: (i) => {
    const e = ee(i ?? {}, cs), t = new yt(e);
    i != null && i.position && A({ position: i.position, x: i.x, y: i.y }, t), i != null && i.scale && k({ scale: i.scale ?? 1, scaleX: i.scaleX, scaleY: i.scaleY }, t), i != null && i.pivot && L(i.pivot, t);
    const s = V(
      ["x", "y", "position", "text", "roundPixels", "resolution", "style", "anchor", "pivot"],
      i ?? {}
    );
  ...
  button: (i) => {
    const e = ee(i ?? {}, Ke), t = V(Ke, i ?? {}), s = new _s(e);
    if (!t)
      return s;
    const { position: n, x: o, y: r, pivot: a, scale: h, scaleX: u, scaleY: c, ...d } = t;
    return A({ position: n, x: o, y: r }, s), k({ scale: h, scaleX: u, scaleY: c }, s), L(a, s), S(d, s), s;
  },
  flexContainer: (i) => {
    const e = ee(i ?? {}, Xe), t = V(Xe, i ?? {}), s = new ne(e);
    if (!t)
      return s;
    const { position: n, x: o, y: r, pivot: a, scale: h, scaleX: u, scaleY: c, ...d } = t;
    return A({ position: n, x: o, y: r }, s), k({ scale: h, scaleX: u, scaleY: c }, s), L(a, s), S(d, s), s;
  ...
  uiCanvas: (i) => {
    const e = ee(i ?? {}, Ye), t = V(Ye, i ?? {}), s = new oe(e);
    if (!t)
      return s;
    const { position: n, x: o, y: r, pivot: a, scale: h, scaleX: u, scaleY: c, ...d } = t;
    return A({ position: n, x: o, y: r }, s), k({ scale: h, scaleX: u, scaleY: c }, s), L(a, s), S(d, s), s;
  ...
  spine: (i) => {
    ...
    return A({ position: s, x: n, y: o }, t), k({ scale: h, scaleX: u, scaleY: c }, t), xe(r, t), L(a, t), S(d, t), t;
  },
  spineAnimation: (i) => {
    const e = new bs(i);
    if (!i)
...
function Q(i) {
  return class extends Y {
    constructor() {
      super(), i = Object.assign(ot, i), this.make = We(i, this, !1), this.add = We(i, this, !0);
    }
  };
}
const Me = class Me {
};
Me.get = Object.assign(ot, {});
let He = Me;
const ds = ls(q(Q()));
class R extends ds {
  /**
  ...
  constructor(e = { autoResize: !0, autoUpdate: !1, priority: 0 }) {
    super(), this.__config = e, this.__dill_pixel_method_binding_root = !0, P(this), this.on("added", this._added), this.on("removed", this._removed);
  }
  /**
...
class _s extends fs {
   ...
   */
  constructor(e) {
    super(), this.onDown = new l(), this.onUp = new l(), this.onUpOutside = new l(), this.onOut = new l(), this.onOver = new l(), this.onClick = new l(), this.onEnabled = new l(), this.onDisabled = new l(), this.onKeyboardEvent = new l(), this._isDownCallbacks = /* @__PURE__ */ new Map(), this._isDownListenerAdded = !1, P(this), this.config = Object.assign(
      {
        textures: { default: "" },
        sheet: void 0,
        enabled: !0,
  ...
  handlePointerOver() {
    ...
    this._enabled && (this.isOver || (this.isOver = !0), !this.isDown && (this.view.texture = this.make.texture({
      ...
      sheet: this.config.sheet
    }), this.onOver.emit(), (e = this.config.sounds) != null && e.hover && this.app.audio.play(this.config.sounds.hover, "sfx"), (t = this.config.actions) != null && t.hover && this._doAction(this.config.actions.hover)));
  }
  /**
  ...
  handlePointerDown() {
    var e, t, s;
    !this._enabled && !this.isKeyDown || this.isDown || (window.removeEventListener("pointerup", this.handlePointerUpOutside), this.off("pointerupoutside", this.handlePointerUpOutside), window.addEventListener("pointerup", this.handlePointerUpOutside), this.on("pointerupoutside", this.handlePointerUpOutside), this.isDown = !0, this.view.texture = this.make.texture({
      asset: this.config.textures.active || this.config.textures.hover || this.config.textures.default,
      sheet: this.config.sheet
    }), this.onDown.emit(), (e = this.config.sounds) != null && e.down && this.app.audio.play(this.config.sounds.down, "sfx"), (t = this.config.actions) != null && t.down && (s = this.config.actions) != null && s.down && this._doAction(this.config.actions.down));
  }
  /**
  ...
  handlePointerUp() {
    var e, t;
    !this._enabled || !this.isOver || (window.removeEventListener("pointerup", this.handlePointerUpOutside), this.view.texture = this.make.texture({ asset: this.config.textures.default, sheet: this.config.sheet }), this.onUp.emit(), (e = this.config.sounds) != null && e.up && this.app.audio.play(this.config.sounds.up, "sfx"), (t = this.config.actions) != null && t.up && this._doAction(this.config.actions.up));
  }
  handleClick() {
    var e, t;
    this.isDown = !1, this.onClick.emit(), (e = this.config.sounds) != null && e.click && this.app.audio.play(this.config.sounds.click, "sfx"), (t = this.config.actions) != null && t.click && this._doAction(this.config.actions.click);
  }
  /**
   * @description Handles the pointer up event.
   */
  handlePointerUpOutside() {
    var e, t;
    this._enabled && (window.removeEventListener("pointerup", this.handlePointerUpOutside), this.off("pointerupoutside", this.handlePointerUpOutside), this.view.texture = this.make.texture({ asset: this.config.textures.default, sheet: this.config.sheet }), this.isDown = !1, this.isOver = !1, this.onUpOutside.emit(), (e = this.config.sounds) != null && e.up && this.app.audio.play(this.config.sounds.up, "sfx"), (t = this.config.actions) != null && t.up && this._doAction(this.config.actions.up));
  }
  _doAction(e) {
    typeof e == "function" ? e() : (e.data.button || (e.data.button = this), this.app.exec.sendAction(e.id, e.data));
  }
...
class oi extends Y {
  ...
  set lerp(e) {
    (e < 0 || e > 1) && f.error("Camera lerp value must be in the range [0, 1]"), this._lerp = Math.max(0, Math.min(e, 1));
  }
  get target() {
    return this._target;
  }
...
class ne extends ps {
    ...
    if (this._childMap.has(e)) {
      if (e instanceof ne)
        try {
          ...
          f.warn("FlexContainer:: Error disconnecting signal from removed child"), console.warn(s);
        }
  ...
  handleChildAdded(e) {
    ...
    s.x < 0 && (t.pivot.x = s.x), s.y < 0 && (t.pivot.y = s.y), e instanceof ne && this.addSignalConnection(e.onLayoutComplete.connect(this.layout)), this._childMap.set(e, t), this.setFlexChildren(), this._reparentAddedChild = !0, this.app.render(), this.layout();
  }
  /**
  ...
  _layout() {
    var Oe, Ue;
    this.config.bindTo && (this.config.width = ((Oe = this.config.bindTo) == null ? void 0 : Oe.width) ?? 0, this.config.height = ((Ue = this.config.bindTo) == null ? void 0 : Ue.height) ?? 0), this.config.bindToAppSize && (this.config.width = this.app.size.width, this.config.height = this.app.size.height);
    const e = ["flex-start"];
    ...
    let J = [], ve = 0;
    const ct = (_, x, y) => o === "row" && x + _.width + n > t || o === "column" && y + _.height + n > s, dt = () => {
      o === "row" ? Fe += v + n : Te += Z + n, c = 0, d = 0, v = 0, Z = 0;
    }, ft = (_) => {
      o === "row" ? (c += _.width + n, v = Math.max(v, _.height)) : (d += _.height + n, Z = Math.max(Z, _.width));
      ...
      _.forEach(({ index: Ie }, ye) => {
        ...
        switch (h) {
          ...
          case "center":
            ...
            break;
          case "space-between":
            O = _.length > 1 ? ye * (w / (_.length - 1)) : 0;
            break;
          case "space-around":
            O = w / _.length * ye + w / (2 * _.length);
            break;
          case "space-evenly":
            O = w / (_.length + 1) * (ye + 1);
            break;
    ...
    me.forEach((_, x) => {
      if (!_)
        return;
      const y = _;
      r === "wrap" && ct(y, c, d) && (ze(J, ve, o === "column" ? d - n : c - n, o), dt(), J = [], ve = c), J.push({ index: x, width: y.width, height: y.height }), j[x] = { x: _t(c), y: pt(d) }, ft(y);
    }), ze(J, ve, o === "column" ? d - n : c - n, o), gt(j, me), u = j, me.forEach((_, x) => {
      const y = _, { x: U, y: w } = u[x] || { x: 0, y: 0 };
      y.position.set(U, w);
    });
...
const Ye = ["debug", "padding", "size", "useAppSize"], ms = q(Q());
class oe extends ms {
  constructor(e) {
    super(), this.settingsMap = /* @__PURE__ */ new Map(), this._childMap = /* @__PURE__ */ new Map(), this._reparentAddedChild = !0, this._disableAddChildError = !1, this._canvasChildren = [], this.removeChildren = (t, s) => this._inner.removeChildren(t, s), this.removeChildAt = (t) => this._inner.removeChildAt(t), this.addChildAt = (t, s) => {
      ...
      debug: e.debug === !0,
      padding: be((e == null ? void 0 : e.padding) ?? 0),
      size: e.size !== void 0 ? Re(e.size) : { width: 0, height: 0 },
  ...
  set size(e) {
    this.config.useAppSize = !1, this.config.size = e === void 0 ? { width: 0, height: 0 } : Re(e), this.resize();
  }
  set padding(e) {
    this.config.padding = be(e), this._inner.position.set(this.config.padding.left, this.config.padding.top), this.resize();
  }
  static isFlexContainer(e) {
    return (e == null ? void 0 : e.flexChildren) !== void 0;
  }
  addChild(...e) {
    return this._disableAddChildError ? super.addChild(...e) : (f.warn(
  ...
  addElement(e, t) {
    ...
    return n.x < 0 && (s.pivot.x = n.x), n.y < 0 && (s.pivot.y = n.y), e != null && e.flexChildren && this.addSignalConnection(e.onLayoutComplete.connect(this.layout)), this.settingsMap.set(s, {
      ...
      padding: t != null && t.padding ? be(t.padding) : { top: 0, left: 0, bottom: 0, right: 0 }
  ...
  __calculateOuterBounds(e) {
    return new Be(0, 0, e.width, e.height);
  }
  _childRemoved(e) {
  ...
  applySettings(e, t) {
    if (!t)
      return;
    const s = this._displayBounds.width, n = this._displayBounds.height, o = e.getChildAt(0), r = oe.isFlexContainer(o) && o.containerWidth || e.width, a = oe.isFlexContainer(o) && o.containerHeight || e.height;
    switch (t.align) {
      case "top right":
        e.x = s - r, e.y = 0;
        break;
    ...
    e.x += te(t.padding.left, s) - te(t.padding.right, s), e.y += te(t.padding.top, n) - te(t.padding.bottom, n);
  }
  drawDebug() {
...
const vs = {
  color: 0,
  alpha: 0.75
}, ys = { backing: !0, closeOnEscape: !0, closeOnPointerDownOutside: !0 };
class G extends R {
  /**
   * Create a new Popup
   ...
   */
  constructor(e, t = {}) {
    super(), this.id = e, this.isShowing = !1, this.config = Object.assign({ id: e, ...ys }, t), this._initialize();
  }
  get data() {
  ...
  static makeBacking(e, t) {
    ...
    const r = o.addChild(new Le(G.BACKING_TEXTURE));
...
class xs extends M {
  constructor() {
    super(...arguments), this.id = "popups", this.view = new R(), this.onShowPopup = new l(), this.onHidePopup = new l(), this._popups = /* @__PURE__ */ new Map(), this._activePopups = /* @__PURE__ */ new Map(), this._currentPopupId = void 0;
  }
  ...
  // eslint-disable-next-line @typescript-eslint/no-unused-vars
  initialize(e) {
    P(this), this.view.label = "PopupManager", this._setupAppListeners();
  }
  /**
  ...
  async hidePopup(e, t) {
    ...
    if (s)
      return s.beforeHide(), await s.hide(), this.view.removeChild(s), this._activePopups.delete(e), this._currentPopupId = ((n = tt(this._activePopups)) == null ? void 0 : n[0]) || void 0, this.onHidePopup.emit({ id: e, data: t }), s.end(), s;
  }
  /**
   * Remove all popups
...
class Ne {
  constructor(e, t, s) {
    this.id = e, this.channel = t, this.manager = s, this.onStart = new l(), this.onStop = new l(), this.onEnd = new l(), this.onPaused = new l(), this.onResumed = new l(), this.onProgress = new l(), this._volume = 1, this._muted = !1, this._isPlaying = !1, P(this), this.muted = this.channel.muted;
  }
  get media() {
    return this._media;
  }
  ...
  remove() {
    this._isPlaying = !1, this.channel.remove(this.id);
  }
  stop() {
    this._media && this._media.stop(), this._isPlaying = !1, this.onEnd.emit(this);
  }
  updateVolume() {
  ...
  fadeTo(e, t) {
    return E.to(this.media, { volume: e, duration: t });
  }
  play(e) {
    this._isPlaying = !0, e ? this.media.play({ start: e }) : this.media.play({});
  }
  _handleMediaEnded() {
    this._isPlaying = !1, this.onEnd.emit(this);
  }
  _handleMediaStarted() {
    this._isPlaying = !0, this.onStart.emit(this);
  }
  _handleMediaStopped() {
    this._isPlaying = !1, this.onStop.emit(this);
  }
  _handleMediaPaused() {
    this._isPlaying = !1, this.onPaused.emit(this);
  }
...
let As = 0;
const Ae = class extends N {
  /** @param parent - Parent element */
  constructor(i) {
    super(), this.id = As++, this.init(i);
  }
  /**
  ...
  play(i) {
    ...
    t && console.assert(t > e, "End time is before start time"), this._speed = s, this._volume = o, this._loop = !!n, this._muted = r, this.refresh(), this.loop && t !== null && (console.warn('Looping not support when specifying an "end" time'), this.loop = !1), this._start = e, this._end = t || this._duration, this._start = Math.max(0, this._start - Ae.PADDING), this._end = Math.min(this._end + Ae.PADDING, this._duration), this._source.onloadedmetadata = () => {
      this._source && (this._source.currentTime = e, this._source.onloadedmetadata = null, this.emit("progress", e, this._duration), W.shared.add(this._onUpdate, this));
   ...
   */
  _onComplete() {
    W.shared.remove(this._onUpdate, this), this._internalStop(), this.emit("progress", 1, this._duration), this.emit("end", this);
  }
  /** Don't use after this. */
  destroy() {
    W.shared.remove(this._onUpdate, this), this.removeAllListeners();
...
class Ts extends N {
  constructor(e) {
    super(), this.id = Fs++, this._media = null, this._paused = !1, this._muted = !1, this._elapsed = 0, this.init(e);
  }
  /**
   * Set a property by name, this makes it easy to chain values
   * @param name - Name of the property to set.
  ...
  enableTicker(e) {
    W.shared.remove(this._updateListener, this), e && W.shared.add(this._updateListener, this);
  }
  /** The current playback progress from 0 to 1. */
  get progress() {
...
const lt = class extends ht {
   ...
   */
  get script() {
    return this._script || (this._script = this.context.audioContext.createScriptProcessor(lt.BUFFER_SIZE), this._script.connect(this.context.destination)), this._script;
  }
  /** Cleans up. */
  destroy() {
...
class zs {
   ...
   */
  init(e) {
    this.parent = e, this._nodes = new ut(this.context), this._source = this._nodes.bufferSource, this.source = e.options.source;
  }
  ...
  async _loadUrl(e) {
    const t = this.parent.url, s = await wt.get().fetch(t);
...
const $ = class {
  ...
  static from(i) {
    ...
    const t = K().useLegacy ? new ks() : new zs();
    return new $(t, e);
  }
  /**
   * Use `Sound.from`
   ...
   */
  preferUrl(i) {
    const [e] = i.map((t) => ({ url: t, ext: se.extname(t).slice(1) })).filter(({ ext: t }) => ae[t]).sort((t, s) => re.indexOf(t.ext) - re.indexOf(s.ext));
    if (!e)
   ...
   */
  _poolInstance(i) {
    i.destroy(), $._pool.indexOf(i) < 0 && $._pool.push(i);
  }
};
let he = $;
he._pool = [];
...
class Ds {
   ...
   */
  init() {
    return this.supported && (this._webAudioContext = new X()), this._htmlAudioContext = new Ss(), this._sounds = {}, this.useLegacy = !this.supported, this;
  }
  /**
  ...
  add(e, t) {
    ...
    if (console.assert(!this._sounds[e], `Sound with alias ${e} already exists.`), t instanceof he)
      return this._sounds[e] = t, t;
    const s = this._getOptions(t), n = he.from(s);
...
const qe = (i) => {
  ...
  return (!t || i.src === t) && (t = se.basename(e, se.extname(e))), t;
}, Os = {
  extension: $e.Asset,
  detection: {
    test: async () => !0,
    add: async (i) => [...i, ...re.filter((e) => ae[e])],
  ...
  loader: {
    ...
    test(i) {
      const e = se.extname(i).slice(1);
      return !!ae[e] || Es.some((t) => i.startsWith(`data:${t}`));
    },
    /** Load the sound file, this is mostly handled by Sound.from() */
    async load(i, e) {
      const t = await new Promise((s, n) => he.from({
        ...e.data,
        url: i,
        preload: !0,
        loaded(o, r) {
...
class Us extends M {
  ...
  isPlaying(e, t) {
    ...
    return s ? ((n = s.get(e)) == null ? void 0 : n.isPlaying) === !0 : !1;
  }
  /**
  ...
  async fadeIn(e, t = "music", s) {
    const n = this._channels.get(t);
    n && (e = this._verifySoundId(e)), n != null && n.get(e) || await this.play(e, t, { volume: 0 }), (s == null ? void 0 : s.volume) === 0 && f.warn("fadeIn volume is 0", e, t, s);
  ...
  async fadeOut(e, t = "music", s = { volume: 0 }) {
    s || (s = {}), (s == null ? void 0 : s.volume) === void 0 && (s.volume = 0), (s == null ? void 0 : s.volume) > 0 && f.warn("fadeOut volume should probably be 0", e, t, s);
  ...
  async restore() {
    var t;
    const e = (t = b == null ? void 0 : b.context) == null ? void 0 : t.audioContext;
    e && await e.resume(), this._storedVolume !== void 0 && (this.masterVolume = this._storedVolume), this.muted = this._muted, this.resume();
  }
  /**
  ...
  load(e, t = "sfx", s) {
    ...
    for (let n of e) {
      ...
      if (o) {
        ...
        const a = o.add(n, new Ne(n, o, this));
  ...
  _verifySoundId(e) {
    ...
    if (!b.exists(e))
      if (b.exists(e + ".mp3"))
        e += ".mp3";
      else if (b.exists(e + ".ogg"))
        e += ".ogg";
      else if (b.exists(e + ".wav"))
        e += ".wav";
      else {
        e = t;
        let s = p.get(e);
    ...
    return f.log(`Sound with id:${t} is now mapped to id:${e}`), this._idMap.set(e, e), e;
  }
  ...
  _setMuted() {
    this._channels.forEach((e) => {
      e.muted = this._muted;
    }), this._muted ? b.muteAll() : b.unmuteAll(), this.onMuted.emit(this._muted);
  }
  /**
   * @private
   */
  _setPaused() {
    this._paused ? b.pauseAll() : b.resumeAll();
  }
  /**
   * Sets the volume of the specified channel.
   * @param {ChannelName} channelName
...
class Bs extends M {
   ...
   */
  async initialize(e, t) {
    if (super.initialize(e), this._options = { ...Is, ...t }, this._locale = this._options.defaultLocale, this._options.loadAll && this._options.files.length > 0) {
  ...
  t(e, t, s = this._locale) {
    ...
    if (!n)
      return f.error(`i18n:: No dictionary loaded for current locale: ${s}`), "";
    let o = n[e];
    if (!o)
      return f.error(`i18n:: No result found for the key ${e} in the locale: ${this._locale}`), "";
    if (t) {
  ...
  parse(e, t = this._locale) {
    ...
    if (!s)
      return f.error(`i18n:: No dictionary loaded for current locale: ${this._locale}`), "";
    let n = e;
    const o = n.match(/{(.*?)}/g);
  ...
  async loadLocale(e) {
    ...
    if (!t) {
      f.error(`i18n:: Could not find locale file for ${e}`);
      return;
    }
    this._dicts[e] = t.json ? await p.load(t.json) : await ie(t);
  }
  getCoreFunctions() {
    return ["t", "setLocale"];
  }
...
class Rs extends M {
   ...
   */
  _drawDebug() {
    this._debugContainer || (this._debugContainer = this.app.stage.addChild(new R()), this._gfx = this._debugContainer.add.graphics()), this._gfx.clear(), this._gfx.rect(0, 0, this._size.width, this._size.height), this._gfx.stroke({ width: 4, color: 4095 });
  }
}
const Qe = [
  {
...
class g extends Ct {
  constructor() {
    super(), this.__dill_pixel_method_binding_root = !0, this.onPause = new l(), this.onResume = new l(), this.onResize = new l(), this._plugins = /* @__PURE__ */ new Map(), this._center = new T(0, 0), P(this);
  }
  get appVersion() {
    try {
  ...
  async initialize(e) {
    ...
    if (g.instance = this, this.config = Object.assign({ ...js }, e), e.container && (g.containerElement = e.container), f.initialize(this.config.logger), await this.boot(this.config), await this.preInitialize(this.config), await this.initAssets(), await this.init(this.config), await this.registerDefaultPlugins(), this.config.plugins && this.config.plugins.length > 0)
    ...
    if (await this.registerPlugins(), this.config.useStore) {
      if (this._store = new Ht(), this._store.initialize(this), this.config.storageAdapters && this.config.storageAdapters.length > 0)
        for (let t = 0; t < this.config.storageAdapters.length; t++) {
          const s = this.config.storageAdapters[t];
          if (this.store.hasAdapter(s.id)) {
            f.error(`Storage Adapter with id "${s.id}" already registered. Not registering.`);
            continue;
          }
          const n = await ie(s);
  ...
  getPlugin(e) {
    ...
    return t || f.error(`Plugin with name "${e}" not found.`), t;
  }
  async postInitialize() {
  ...
  async loadPlugin(e, t = !1) {
    ...
    const s = await ie(e), n = new s(e.id);
    n.id !== e.id && (n.id = e.id);
    let o = e.options;
  ...
  async registerPlugin(e, t) {
    return this._plugins.has(e.id) ? (f.error(`Plugin with id "${e.id}" already registered. Not registering.`), e.initialize(this, t)) : (e.registerCoreFunctions(), e.registerCoreSignals(), this._plugins.set(e.id, e), e.initialize(this, t));
  }
  async registerDefaultPlugins() {
    ...
    (this.config.showStats === !0 || H && this.config.showStats !== !1) && await this.loadPlugin({
      id: "stats",
  ...
  async initAssets() {
    var t, s;
    const e = ((t = this.config.assets) == null ? void 0 : t.initOptions) || {};
    if ((s = this.config.assets) != null && s.manifest) {
      let n = this.config.assets.manifest || e.manifest;
      et(n) && (n = await n), e.manifest = n;
    }
   ...
   */
  async _setup() {
    return H && (globalThis.__PIXI_APP__ = this), this.webEvents.onResize.connect(this._resize, -1), this.scenes.view.label = "SceneManager", this.stage.addChild(this.scenes.view), this.stage.addChild(this.popups.view), this.focus.view.label = "FocusManager", this.stage.addChild(this.focus.view), this._resize(), Promise.resolve();
  }
}
...
export {
  ...
  Cs as AudioChannel,
  Ne as AudioInstance,
  Us as AudioManagerPlugin,
  _s as Button,
  Ke as ButtonConfigKeys,
  oi as Camera,
  ri as CameraController,
  ai as Collector,
  hi as CollectorArray,
  li as CollectorLast,
  ui as CollectorUntil0,
  ci as CollectorWhile0,
  R as Container,
  ne as FlexContainer,
  Xe as FlexContainerConfigKeys,
  hs as FocusManagerPlugin,
  rs as FocusOutliner,
  nt as Focusable,
  B as InputController,
  ns as InputPlugin,
  us as Interactive,
  os as KeyboardPlugin,
  ti as LocalStorageAdapter,
  f as Logger,
  M as Plugin,
  G as Popup,
  xs as PopupManagerPlugin,
  Rt as Queue,
  Rs as ResizerPlugin,
  ni as Scene,
  ...
  Ht as Store,
  oe as UICanvas,
  Ye as UICanvasConfigKeys,
  ts as WebEventsPlugin,
  q as WithSignals,
  P as bindAllMethods,
  Gt as bindMethods,
  Ce as capitalize,
  Ks as capitalizeWords,
  Qs as checkAndInvokeMethod,
  Ns as clamp,
  Pe as coreFunctionRegistry,
  st as coreSignalRegistry,
  ei as create,
  qt as createContainer,
  $t as createQueue,
  Ys as debounce,
  Bt as delay,
  be as ensurePadding,
  Je as env,
  ie as getDynamicModuleFromImportListItem,
  tt as getLastMapEntry,
  je as getPreviousMapEntry,
  Vt as getSheetLikeString,
  Bs as i18nPlugin,
  H as isDev,
  Js as isMobile,
  Hs as isProduction,
