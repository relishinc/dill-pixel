...
import { hideLoadScreen, initState, loadAssets, showLoadScreen, Signals, stateTransitionHalted, unloadAssets } from "../Signals";
...
export class StateManager extends Container {
    ...
    set defaultTransitionType(pTransitionType) {
     ...
     */
    register(pIdOrClass, pCreate) {
        if (typeof pIdOrClass === "string") {
            this._stateData.setValue(pIdOrClass, { create: pCreate });
        }
        else {
    ...
    getStateFromHash() {
        var _a, _b;
        let hash = (_a = window === null || window === void 0 ? void 0 : window.location) === null || _a === void 0 ? void 0 : _a.hash;
        if (hash) {
            hash = hash.replace("#", "");
            const registeredStates = this.getRegisteredStateIds();
            if (hash.length > 0) {
                for (let i = 0; i < registeredStates.length; i++) {
                    if (((_b = registeredStates[i]) === null || _b === void 0 ? void 0 : _b.toLowerCase()) === hash.toLowerCase()) {
    ...
    startTransition(pStateId, pLoadScreen) {
        ...
        if (this._statesMenu) {
            (_a = this._statesMenu.querySelector("select")) === null || _a === void 0 ? void 0 : _a.setAttribute("disabled", "true");
        }
    ...
    setAndPerformTransitionStep(pStepIndex) {
        ...
        if (this._transitionStepIndex < this._newStateToken.transitionSteps.length) {
            ...
            if (this._statesMenu) {
                (_a = this._statesMenu.querySelector("select")) === null || _a === void 0 ? void 0 : _a.removeAttribute("disabled");
            }
        }
    }
    /**
    ...
    performStepAnimCurrentOut() {
        ...
        if (this._currentState === undefined) {
            ...
            (_a = this._currentState) === null || _a === void 0 ? void 0 : _a.animateOut(this.handleViewAnimateOutComplete.bind(this));
        }
    }
    /**
    ...
    trimUnloadList(pOldStateId, pNewStateId) {
        const oldAssets = AssetMap.getAssetGroup(pOldStateId);
        const newAssets = AssetMap.getAssetGroup(pNewStateId);
