import { P as o, C as u, S as i, b as r, f as n } from "./index-DH1sq-Gb.mjs";
class c extends o {
  constructor() {
  ...
  initialize(e) {
    r(this), this.view.name = "PopupManager", this._setupAppListeners();
  }
  /**
...
//# sourceMappingURL=PopupManagerPlugin-DbOR6uGT.mjs.map
