...
import { CompoundHitArea } from "./CompoundHitArea.ts";
import { PixelPerfectHitArea } from "./PixelPerfectHitArea.ts";
/**
 * Hit area renderer
 */
export class HitAreaRenderer extends Container {
    ...
    renderRecursive(pTarget) {
        if (((pTarget === null || pTarget === void 0 ? void 0 : pTarget.eventMode) !== "none" || (pTarget === null || pTarget === void 0 ? void 0 : pTarget.interactive) === true) && pTarget.worldVisible === true) {
    ...
    renderTarget(pTarget) {
        ...
        if (!(pTarget === null || pTarget === void 0 ? void 0 : pTarget.parent)) {
            return;
        }
        ...
        console.log("rendering", pTarget === null || pTarget === void 0 ? void 0 : pTarget.name, hitArea);
        if (hitArea instanceof Rectangle || hitArea instanceof RoundedRectangle ||
            hitArea instanceof Circle || hitArea instanceof Ellipse || hitArea instanceof Polygon) {
