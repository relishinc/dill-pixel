...
declare const _UICanvas: (new () => import("../mixins/factory").IFactoryContainer<{
    ...
    graphics: (props?: Partial<import("src/mixins/factory/props").GraphicsProps> | undefined) => Graphics;
    ...
    uiCanvas: (props?: Partial<import("src/mixins/factory/props").UICanvasFactoryProps> | undefined) => UICanvas<Application<import("pixi.js").Renderer>>;
