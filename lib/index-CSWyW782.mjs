import { Application as Et, Point as S, isMobile as Ot, Assets as T, Container as N, Sprite as K, Graphics as G, Text as zt, BitmapText as Tt, HTMLText as Ht, Texture as It, Rectangle as lt, TextStyle as Nt, HTMLTextStyle as Kt } from "pixi.js";
...
const Dt = process.env.NODE_ENV, I = Dt === "development", Fe = Dt === "production", f = class f {
  constructor(t = "") {
...
const ct = {}, Ut = {}, xt = [
  {
    id: "assets",
    module: () => import("./AssetsPlugin-s5UcXy3W.mjs"),
    namedExport: "AssetsPlugin"
  },
  {
    id: "webEvents",
    module: () => import("./WebEventsPlugin-BJh4a7MV.mjs"),
    namedExport: "WebEventsPlugin"
  },
  {
    id: "scenes",
    module: () => import("./SceneManagerPlugin-ChnV8weK.mjs"),
    namedExport: "SceneManagerPlugin"
  },
  {
    id: "input",
    module: () => import("./InputPlugin-CrSY9lqr.mjs"),
    namedExport: "InputPlugin"
  },
  {
    id: "keyboard",
    module: () => import("./KeyboardPlugin-CZAMvi8-.mjs"),
    namedExport: "KeyboardPlugin"
  },
  {
    id: "focus",
    module: () => import("./FocusManagerPlugin-CdbdAZa1.mjs"),
    namedExport: "FocusManagerPlugin"
  },
  {
    id: "popups",
    module: () => import("./PopupManagerPlugin-DyzAuc3B.mjs"),
    namedExport: "PopupManagerPlugin"
  },
  {
    id: "audio",
    module: () => import("./AudioManagerPlugin-CO0T91h9.mjs"),
    namedExport: "AudioManagerPlugin"
  },
  {
    id: "i18n",
    module: () => import("./i18nPlugin-D9_TpPQl.mjs"),
    namedExport: "i18nPlugin"
  },
  {
    id: "resizer",
    module: () => import("./ResizerPlugin-DOkgpkLy.mjs"),
  ...
  async initialize(t) {
    ...
    if (P.instance = this, this.config = Object.assign({ ...de }, t), await this.boot(this.config), await this.preInitialize(this.config), await this.initAssets(), await this.init(this.config), p.initialize(t.id), await this.registerDefaultPlugins(), this.config.plugins && this.config.plugins.length > 0)
  ...
  async boot(t) {
    p.log(`${this.constructor.name}:: v${this.appVersion}`);
  }
  /**
  ...
  async preInitialize(t) {
    t.useSpine && await this.loadPlugin({
      id: "SpinePlugin",
      module: () => import("./SpinePlugin-i-Fju1QX.mjs"),
...
const bt = ["textures", "cursor", "disabledCursor", "sheet", "enabled"], ye = jt(ve(B(X())));
class xe extends ye {
  /**
   * @constructor
...
class D extends ke {
  constructor(t = {}) {
    ...
    }, E(this), this.config = Object.assign({ ...Pe }, t), this.on("added", this._added), this.on("childAdded", this.handleChildAdded), this.on("childRemoved", this.handleChildRemoved), this.layout();
  }
  get flexChildren() {
  ...
  _layout() {
    ...
    let l = [], u = 0, g = 0, k = 0, W = 0, gt = 0, ft = 0;
    const U = [], nt = this.children.filter(Boolean);
    let R = [], ot = 0;
    const Bt = (c, v, _) => o === "row" && v + c.width + n > e || o === "column" && _ + c.height + n > s, Xt = () => {
      o === "row" ? gt += k + n : ft += W + n, u = 0, g = 0, k = 0, W = 0;
    }, Wt = (c) => {
      o === "row" ? (u += c.width + n, k = Math.max(k, c.height)) : (g += c.height + n, W = Math.max(W, c.width));
    ...
    nt.forEach((c, v) => {
      if (!c)
        return;
      const _ = c;
      r === "wrap" && Bt(_, u, g) && (pt(R, ot, o === "column" ? g - n : u - n, o), Xt(), R = [], ot = u), R.push({ index: v, width: _.width, height: _.height }), U[v] = { x: Rt(u), y: $t(g) }, Wt(_);
...
const Pt = ["debug", "padding", "size", "useAppSize"], Me = B(X());
class Ee extends Me {
  constructor(t) {
...
const Ft = {
  ...
  flexContainer: (i) => {
    const t = $(i ?? {}, kt), e = j(kt, i ?? {}), s = new D(t);
    if (!e)
      return s;
    const { position: n, x: o, y: r, pivot: a, scale: h, scaleX: l, scaleY: u, ...g } = e;
    return x({ position: n, x: o, y: r }, s), C({ scale: h, scaleX: l, scaleY: u }, s), b(a, s), y(g, s), s;
  ...
  uiCanvas: (i) => {
    const t = $(i ?? {}, Pt), e = j(Pt, i ?? {}), s = new Ee(t);
    if (!e)
      return s;
    const { position: n, x: o, y: r, pivot: a, scale: h, scaleX: l, scaleY: u, ...g } = e;
    return x({ position: n, x: o, y: r }, s), C({ scale: h, scaleX: l, scaleY: u }, s), b(a, s), y(g, s), s;
...
//# sourceMappingURL=index-CSWyW782.mjs.map
