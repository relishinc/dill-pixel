...
export declare class Make {
    ...
    static physicsSprite(asset?: string | Texture, sheet?: SpritesheetLike, size?: PointLike, bodyType?: PhysicsBodyType, alpha?: number, position?: PointLike, scale?: PointLike): IPhysicsObject;
}
