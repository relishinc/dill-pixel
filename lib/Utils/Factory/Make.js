...
export class Make {
    ...
    static coloredSprite(color = 0x0, size = {
        ...
        switch (shape) {
            ...
            case "rounded_rectangle":
                gfx.drawRoundedRect(0, 0, resolvedSize.x, resolvedSize.y, (opts === null || opts === void 0 ? void 0 : opts.radius) || 5);
                break;
            case "rectangle":
            default:
    ...
    static tiledSprite(pTexture, pSheet, pWidth, pHeight, pTilePosition) {
