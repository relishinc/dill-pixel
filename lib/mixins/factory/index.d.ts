...
export declare const defaultFactoryMethods: {
    ...
    container: (props?: Partial<ContainerProps>) => Container<import("src").Application<import("pixi.js").Renderer>>;
...
export declare class Factory {
    static get: {
        ...
        texture: typeof resolveTexture;
        container: (props?: Partial<ContainerProps> | undefined) => Container<import("src").Application<import("pixi.js").Renderer>>;
        ...
        flexContainer: (props?: Partial<FlexContainerProps> | undefined) => FlexContainer<import("src").Application<import("pixi.js").Renderer>>;
        uiCanvas: (props?: Partial<UICanvasFactoryProps> | undefined) => UICanvas<import("src").Application<import("pixi.js").Renderer>>;
