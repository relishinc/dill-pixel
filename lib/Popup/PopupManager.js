...
export class PopupManager extends Container {
    constructor(app, pOverlayColor = 0x000000, pOverlayAlpha = 0.75) {
        ...
        subscribe(Topics.HIDE_ALL_POPUPS, this.handleHideAllPopups.bind(this));
        subscribe(Topics.HIDE_TOPMOST_POPUP, this.handleHideTopmostPopup.bind(this));
        subscribe(Topics.HIDE_POPUP_COMPLETE, this.handleHidePopupComplete.bind(this));
