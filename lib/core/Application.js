...
import { Add, AssetUtils, delay, HTMLTextStyleManager, Make, OrientationManager, ResizeManager, WebEventsManager } from '../utils';
...
export class Application extends PIXIApplication {
    ...
    static get instance() {
        if (Application._instance === undefined) {
            console.error("You've tried to access the instance of DillPixel.Application when it hasn't been set. " +
