 ...
 * @constructor
 */
export function MethodBindingRoot(constructor) {
 ...
 * @constructor
 */
export function CoreFunction(target, prop) {
 ...
 * @constructor
 */
export function CoreModule(constructor) {
    ...
    function construct(constructor, args) {
        ...
        const coreFunctions = constructor.__dill_pixel_core_functions;
