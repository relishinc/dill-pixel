import { Application as Et, Point as S, isMobile as Ot, Assets as T, Container as H, Sprite as N, Graphics as K, Text as zt, BitmapText as Tt, HTMLText as Vt, Texture as Dt, Rectangle as lt, TextStyle as Zt, HTMLTextStyle as Jt } from "pixi.js";
...
Q.CollectorUntil0 = ne;
var q = {};
Object.defineProperty(q, "__esModule", { value: !0 });
q.CollectorWhile0 = void 0;
const oe = M;
class ae extends oe.Collector {
  constructor() {
    super(...arguments), this.result = !1;
  }
  handleResult(t) {
...
let ce = class {
  constructor() {
    this.head = new le.SignalLink(), this.hasNewLinks = !1, this.emitDepth = 0, this.connectionsCount = 0;
  }
  /**
  ...
  connect(t, e = 0) {
    ...
    return this.emitDepth > 0 && (this.hasNewLinks = !0, s.newLink = !0), new he.SignalConnectionImpl(s, () => this.decrementConnectionCount());
  }
...
const It = process.env.NODE_ENV, D = It === "development", Re = It === "production", f = class f {
  constructor(t = "") {
...
const ge = (i = 0) => new Promise((t) => setTimeout(t, i * 1e3)), Lt = (i) => i && typeof i.then == "function";
function fe(i) {
  return typeof i == "function" && /^class\s/.test(Function.prototype.toString.call(i));
}
async function yt(i) {
  let t, e;
  return Lt(i.module) ? (t = await i.module, e = i != null && i.namedExport ? t[i.namedExport] : t.default) : typeof i.module == "function" ? fe(i.module) ? (t = i.module, e = t) : (t = await i.module(), e = i != null && i.namedExport ? t[i.namedExport] : t.default) : (t = i.module, e = t), e;
}
function $e(i, ...t) {
  t.forEach((e) => {
    const s = i[e];
...
const ct = {}, Ut = {}, me = {
  ...
  async initialize(t) {
    ...
    if (k.instance = this, this.config = Object.assign({ ...me }, t), await this.preInitialize(this.config), await this.initAssets(), await this.init(this.config), p.initialize(t.id), this.config.useDefaults && await this.registerDefaultPlugins(), this.config.plugins && this.config.plugins.length > 0)
    ...
    if (await this.registerPlugins(), this.config.useStore) {
      if (this._store = new ue(), this._store.initialize(this), this.config.storageAdapters && this.config.storageAdapters.length > 0)
  ...
  async preInitialize(t) {
    t.useSpine && await this.loadPlugin({
      id: "SpinePlugin",
      module: () => import("./SpinePlugin-VTWqylMU.mjs"),
  ...
  async registerDefaultPlugins() {
    await this.loadPlugin({
      id: "assets",
      module: () => import("./AssetsPlugin-Bs3WZhmK.mjs"),
      namedExport: "AssetsPlugin"
    }), await this.loadPlugin({
      id: "input",
      module: () => Promise.resolve().then(() => ye),
      namedExport: "InputPlugin"
    }), await this.loadPlugin({
      id: "scenes",
      module: () => import("./SceneManagerPlugin-CSmT44AS.mjs"),
      namedExport: "SceneManagerPlugin"
    }), await this.loadPlugin({
      id: "webEvents",
      module: () => import("./WebEventsPlugin-EYqw-vEn.mjs"),
      namedExport: "WebEventsPlugin"
    }), await this.loadPlugin({
      id: "keyboard",
      module: () => import("./KeyboardPlugin-CwBw4V2y.mjs"),
      namedExport: "KeyboardPlugin"
    }), await this.loadPlugin({
      id: "focus",
      module: () => import("./FocusManagerPlugin-Bt_tz-Yw.mjs"),
      namedExport: "FocusManagerPlugin"
    }), await this.loadPlugin({
      id: "popups",
      module: () => import("./PopupManagerPlugin-BC68-8Gl.mjs"),
      namedExport: "PopupManagerPlugin"
    }), await this.loadPlugin({
      id: "audio",
      module: () => import("./AudioManagerPlugin-Dw65bYb2.mjs"),
      namedExport: "AudioManagerPlugin"
    }), await this.loadPlugin({
      id: "i18n",
      module: () => import("./i18nPlugin-DbP70AbG.mjs"),
      namedExport: "i18nPlugin"
    }), await this.loadPlugin({
      id: "resizer",
      module: () => import("./ResizerPlugin-C6UGEIwR.mjs"),
      namedExport: "ResizerPlugin"
    }), (this.config.showStats === !0 || D && this.config.showStats !== !1) && await this.loadPlugin({
      id: "stats",
      module: () => import("./StatsPlugin-E3EwvYIq.mjs"),
      namedExport: "StatsPlugin"
    }), this.config.useVoiceover && (await this.loadPlugin({
      id: "voiceover",
      module: () => import("./VoiceOverPlugin-C3ytvcYE.mjs"),
      namedExport: "VoiceOverPlugin",
      options: this.config.voiceover || void 0
    }), await this.loadPlugin({
      id: "captions",
      module: () => import("./CaptionsPlugin--nuHT0uP.mjs"),
...
function He(i, t, e) {
  e && t ? i.name = `${_e(e)}/${t}` : typeof t == "string" && (i.name = `${t}`), typeof t == "string" && (i.__textureString = t), Array.isArray(e) ? i.__textureSheetArray = e : e && (i.__textureSheet = e);
}
class Ne extends H {
  constructor(t) {
...
var Ft = /* @__PURE__ */ ((i) => (i.Keyboard = "keyboard", i.Gamepad = "gamepad", i.Mouse = "mouse", i.Touch = "touch", i))(Ft || {}), Bt = /* @__PURE__ */ ((i) => (i.General = "general", i.Menu = "menu", i.Game = "game", i))(Bt || {}), Wt = /* @__PURE__ */ ((i) => (i.Up = "up", i.Down = "down", i.Left = "left", i.Right = "right", i.Action = "action", i.Next = "next", i.Back = "back", i.Pause = "pause", i.Unpause = "unpause", i.Start = "start", i.Menu = "menu", i))(Wt || {});
const we = [
  "up",
  "down",
  "left",
...
const qe = window.devicePixelRatio > 1 || window.matchMedia && window.matchMedia(
...
const bt = ["textures", "cursor", "disabledCursor", "sheet", "enabled"], Pe = Xt(be(B(W())));
class ke extends Pe {
  /**
   * @constructor
...
class I extends Me {
  constructor(t = {}) {
    ...
    }, E(this), this.config = Object.assign({ ...Ee }, t), this.on("added", this._added), this.on("childAdded", this.handleChildAdded), this.on("childRemoved", this.handleChildRemoved), this.layout();
  }
  get flexChildren() {
  ...
  _layout() {
    ...
    let l = [], u = 0, g = 0, P = 0, X = 0, gt = 0, ft = 0;
    const U = [], nt = this.children.filter(Boolean);
    let R = [], ot = 0;
    const $t = (c, v, m) => o === "row" && v + c.width + n > e || o === "column" && m + c.height + n > s, Yt = () => {
      o === "row" ? gt += P + n : ft += X + n, u = 0, g = 0, P = 0, X = 0;
    }, Gt = (c) => {
      o === "row" ? (u += c.width + n, P = Math.max(P, c.height)) : (g += c.height + n, X = Math.max(X, c.width));
    }, Ht = (c) => o === "row" ? c : ft, Nt = (c) => o === "column" ? c : gt, pt = (c, v, m, L) => {
    ...
    nt.forEach((c, v) => {
      if (!c)
        return;
      const m = c;
      a === "wrap" && $t(m, u, g) && (pt(R, ot, o === "column" ? g - n : u - n, o), Yt(), R = [], ot = u), R.push({ index: v, width: m.width, height: m.height }), U[v] = { x: Ht(u), y: Nt(g) }, Gt(m);
    }), pt(R, ot, o === "column" ? g - n : u - n, o), Kt(U, nt), l = U, nt.forEach((c, v) => {
...
const kt = ["debug", "padding", "size", "useAppSize"], Te = B(W());
class De extends Te {
  constructor(t) {
...
const Ie = ["text", "anchor", "resolution", "roundPixels", "style"];
function y(i, t) {
  for (const e in i)
    try {
      t[e] = i[e];
...
const Rt = {
  ...
  button: (i) => {
    const t = $(i ?? {}, bt), e = j(bt, i ?? {}), s = new ke(t);
    if (!e)
      return s;
  ...
  flexContainer: (i) => {
    const t = $(i ?? {}, Pt), e = j(Pt, i ?? {}), s = new I(t);
    if (!e)
      return s;
    const { position: n, x: o, y: a, pivot: r, scale: h, scaleX: l, scaleY: u, ...g } = e;
    return C({ position: n, x: o, y: a }, s), x({ scale: h, scaleX: l, scaleY: u }, s), b(r, s), y(g, s), s;
  ...
  uiCanvas: (i) => {
    const t = $(i ?? {}, kt), e = j(kt, i ?? {}), s = new De(t);
    if (!e)
      return s;
    const { position: n, x: o, y: a, pivot: r, scale: h, scaleX: l, scaleY: u, ...g } = e;
    return C({ position: n, x: o, y: a }, s), x({ scale: h, scaleX: l, scaleY: u }, s), b(r, s), y(g, s), s;
...
function W(i) {
  return class extends H {
    constructor() {
      super(), i = Object.assign(Rt, i), this.make = St(i, this, !1), this.add = St(i, this, !0);
    }
  };
}
const ut = class ut {
};
ut.get = Object.assign(Rt, {});
let Mt = ut;
const Le = {
  color: 0,
  alpha: 0.75
}, Ue = { backing: !0, closeOnEscape: !0, closeOnPointerDownOutside: !0 };
class F extends G {
  /**
   * Create a new Popup
   ...
   */
  constructor(t, e = {}) {
    super(), this.id = t, this.isShowing = !1, this.config = Object.assign({ id: t, ...Ue }, e), this._initialize();
  }
  get data() {
...
const je = "8.3.0";
function Fe() {
  let i = `%cDill Pixel Game Framework v${je}`;
  i += " - %chttps://reli.sh", console.log(i, "color: #74b64c", "color: #74b64c; font-weight: bold");
}
async function oi(i, t = { id: "DillPixelApplication" }, e = w.containerId, s = !0) {
  s && Fe();
  let n = null;
  ...
  return await ge(0.01), await o.postInitialize(), o;
}
export {
  w as A,
  W as B,
...
//# sourceMappingURL=index-ChDTXvc9.mjs.map
