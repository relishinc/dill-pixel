import { Texture as ue, ExtensionType as Yt, LoaderParserPriority as Ue, checkExtension as Lt, DOMAdapter as Oe, path as qt, TextureSource as Me, BigPool as ae, Container as ws, Bounds as ys, Ticker as Wt, Cache as oe, Assets as Te } from "pixi.js";
class qe {
  constructor() {
...
const vt = class vt {
  ...
  static ensureArrayCapacity(t, n, e = 0) {
    return t.length >= n ? t : vt.setArraySize(t, n, e);
  }
  static newArray(t, n) {
    const e = new Array(t);
    for (let r = 0; r < t; r++)
  ...
  static toFloatArray(t) {
    return vt.SUPPORTS_TYPED_ARRAYS ? new Float32Array(t) : t;
  }
  static toSinglePrecision(t) {
    return vt.SUPPORTS_TYPED_ARRAYS ? Math.fround(t) : t;
  }
...
vt.SUPPORTS_TYPED_ARRAYS = typeof Float32Array < "u";
let P = vt;
class $t {
  constructor(t) {
...
const Zt = class Zt extends We {
  constructor(t) {
    super(t), this.id = Zt.nextID++, this.bones = null, this.vertices = [], this.worldVerticesLength = 0, this.timelineAttachment = this;
  }
  ...
  computeWorldVertices(t, n, e, r, i, l) {
    ...
    if (!a) {
      ...
      for (let w = n, v = i; v < e; w += 2, v += l) {
        const k = o[w], A = o[w + 1];
        r[v] = k * y + A * b + m, r[v + 1] = k * g + A * p + x;
      }
      return;
    }
    let h = 0, d = 0;
    ...
    if (s.length == 0)
      for (let u = i, m = d * 3; u < e; u += l) {
        let x = 0, y = 0, b = a[h++];
        for (b += h; h < b; h++, m += 3) {
          const g = f[a[h]], p = o[m], w = o[m + 1], v = o[m + 2];
          x += (p * g.a + w * g.b + g.worldX) * v, y += (p * g.c + w * g.d + g.worldY) * v;
        }
        r[u] = x, r[u + 1] = y;
      }
    else {
      ...
      for (let m = i, x = d * 3, y = d << 1; m < e; m += l) {
        ...
        for (p += h; h < p; h++, x += 3, y += 2) {
          const w = f[a[h]], v = o[x] + u[y], k = o[x + 1] + u[y + 1], A = o[x + 2];
          b += (v * w.a + k * w.b + w.worldX) * A, g += (v * w.c + k * w.d + w.worldY) * A;
        }
        r[m] = b, r[m + 1] = g;
      }
    }
...
Et._nextID = 0;
let Gt = Et;
var bt = /* @__PURE__ */ ((S) => (S[S.hold = 0] = "hold", S[S.once = 1] = "once", S[S.loop = 2] = "loop", S[S.pingpong = 3] = "pingpong", S[S.onceReverse = 4] = "onceReverse", S[S.loopReverse = 5] = "loopReverse", S[S.pingpongReverse = 6] = "pingpongReverse", S))(bt || {});
const ze = [
  0,
  1,
  2,
...
class we {
  constructor(t, n, e) {
    if (this.timelines = [], this.timelineIds = new qe(), !t)
      throw new Error("name cannot be null.");
...
var Q = /* @__PURE__ */ ((S) => (S[S.setup = 0] = "setup", S[S.first = 1] = "first", S[S.replace = 2] = "replace", S[S.add = 3] = "add", S))(Q || {}), At = /* @__PURE__ */ ((S) => (S[S.mixIn = 0] = "mixIn", S[S.mixOut = 1] = "mixOut", S))(At || {});
const $ = {
  rotate: 0,
  x: 1,
  y: 2,
...
class gt extends K {
  ...
  setBezier(t, n, e, r, i, l, c, s, o, a, h) {
    ...
    let b = u * 2 + x, g = m * 2 + y, p = (l - r) * 0.3 + u + x * 0.16666667, w = (c - i) * 0.3 + m + y * 0.16666667, v = r + p, k = i + w;
    for (let A = f + 18; f < A; f += 2)
      d[f] = v, d[f + 1] = k, p += b, w += g, b += x, g += y, v += p, k += w;
  }
...
class ns extends gt {
  ...
  apply(t, n, e, r, i, l, c) {
    ...
    if (e < o[0]) {
      const w = s.data.color, v = s.data.darkColor;
      switch (l) {
        case 0:
          a.setFromColor(w), h.r = v.r, h.g = v.g, h.b = v.b;
          return;
        case 1:
          a.add(
            (w.r - a.r) * i,
            ...
            (w.b - a.b) * i,
            (w.a - a.a) * i
          ), h.r += (v.r - h.r) * i, h.g += (v.g - h.g) * i, h.b += (v.b - h.b) * i;
      }
      return;
    }
...
class rs extends gt {
  ...
  setBezier(t, n, e, r, i, l, c, s, o, a, h) {
    ...
    let b = u * 2 + x, g = m * 2 + y, p = (l - r) * 0.3 + u + x * 0.16666667, w = c * 0.3 + m + y * 0.16666667, v = r + p, k = w;
    for (let A = f + 18; f < A; f += 2)
      d[f] = v, d[f + 1] = k, p += b, w += g, b += x, g += y, v += p, k += w;
  }
  apply(t, n, e, r, i, l, c) {
...
const te = class te extends K {
  constructor(t) {
    super(t, te.propertyIds), this.events = new Array(t);
  }
  getFrameCount() {
    return this.frames.length;
  }
...
te.propertyIds = ["" + $.event];
let Nt = te;
const ee = class ee extends K {
  constructor(t) {
    super(t, ee.propertyIds), this.drawOrders = new Array(t);
  }
  getFrameCount() {
    return this.frames.length;
  }
...
const Bt = class Bt {
  constructor(t) {
    this.tracks = new Array(), this.timeScale = 1, this.unkeyedState = 0, this.events = new Array(), this.listeners = new Array(), this.queue = new Ss(this), this.propertyIDs = new qe(), this.animationsChanged = !1, this.trackEntryPool = new $t(() => new vs()), this.data = t;
  }
  ...
  apply(t) {
    ...
    for (let c = 0, s = e.length; c < s; c++) {
      ...
      if (c == 0 && h == 1 || a == Q.add)
        ...
        for (let w = 0; w < y; w++) {
          const v = x[w], k = b[w] == ce ? a : Q.setup;
          !g && v instanceof jt ? this.applyRotateTimeline(
            v,
            t,
            u,
            h,
            ...
            w << 1,
            p
          ) : v instanceof Tt ? this.applyAttachmentTimeline(v, t, u, a, !0) : v.apply(t, d, u, m, h, k, At.mixIn);
        }
      }
      this.queueEvents(o, f), n.length = 0, o.nextAnimationLast = f, o.nextTrackLast = o.trackTime;
    }
    const i = this.unkeyedState + Be, l = t.slots;
    ...
    if (r.reverse ? u = r.animation.duration - u : i < r.eventThreshold && (m = this.events), e == Q.add)
      ...
      for (let p = 0; p < o; p++) {
        ...
        r.totalAlpha += A, !b && w instanceof jt ? this.applyRotateTimeline(
          ...
          p << 1,
          g
        ) : w instanceof Tt ? this.applyAttachmentTimeline(w, n, u, k, l) : (c && w instanceof It && k == Q.setup && (v = At.mixIn), w.apply(n, d, u, m, A, k, v));
      }
    }
  ...
  applyAttachmentTimeline(t, n, e, r, i) {
    ...
    l.bone.active && (e < t.frames[0] ? (r == Q.setup || r == Q.first) && this.setAttachment(n, l, l.data.attachmentName, i) : this.setAttachment(
      ...
      i
    ), l.attachmentState <= this.unkeyedState && (l.attachmentState = this.unkeyedState + Be));
  }
  setAttachment(t, n, e, r) {
    n.setAttachment(e ? t.getAttachment(n.data.index, e) : null), r && (n.attachmentState = this.unkeyedState + As);
  }
  ...
  computeHold(t) {
    ...
    if (n && n.holdPrevious) {
      for (let s = 0; s < r; s++)
        i[s] = c.addAll(e[s].getPropertyIds()) ? he : Ee;
      return;
    }
    t:
      for (let s = 0; s < r; s++) {
...
Bt._emptyAnimation = new we("<empty>", [], 0);
let me = Bt;
class vs {
  constructor() {
...
const ce = 0, Fe = 1, Ee = 2, he = 3, ks = 4, Be = 1, As = 2;
class Ys {
  constructor(t) {
...
var Z = /* @__PURE__ */ ((S) => (S[S.Nearest = 9728] = "Nearest", S[S.Linear = 9729] = "Linear", S[S.MipMap = 9987] = "MipMap", S[S.MipMapNearestNearest = 9984] = "MipMapNearestNearest", S[S.MipMapLinearNearest = 9985] = "MipMapLinearNearest", S[S.MipMapNearestLinear = 9986] = "MipMapNearestLinear", S[S.MipMapLinearLinear = 9987] = "MipMapLinearLinear", S))(Z || {}), St = /* @__PURE__ */ ((S) => (S[S.MirroredRepeat = 33648] = "MirroredRepeat", S[S.ClampToEdge = 33071] = "ClampToEdge", S[S.Repeat = 10497] = "Repeat", S))(St || {});
class Cs {
  constructor() {
...
class Xs {
  constructor(t) {
    ...
    const n = new Ms(t), e = new Array(4), r = {};
    r.size = (a) => {
      ...
      e[1].indexOf("x") != -1 && (a.uWrap = St.Repeat), e[1].indexOf("y") != -1 && (a.vWrap = St.Repeat);
    }, r.pma = (a) => {
      a.pma = e[1] == "true";
    };
    const i = {};
    ...
    for (; l !== null; )
      if (l.trim().length == 0)
        ...
        for (c = new Ts(l.trim()); n.readEntry(e, l = n.readLine()) != 0; ) {
          const a = r[e[0]];
          a && a(c);
        }
        this.pages.push(c);
...
class Ts {
  constructor(t) {
    this.minFilter = Z.Nearest, this.magFilter = Z.Nearest, this.uWrap = St.ClampToEdge, this.vWrap = St.ClampToEdge, this.texture = null, this.width = 0, this.height = 0, this.pma = !1, this.regions = new Array(), this.name = t;
  }
  setTexture(t) {
...
const W = class W extends We {
  ...
  updateRegion() {
    ...
    const e = this.width / this.region.originalWidth * this.scaleX, r = this.height / this.region.originalHeight * this.scaleY, i = -this.width / 2 * this.scaleX + this.region.offsetX * e, l = -this.height / 2 * this.scaleY + this.region.offsetY * r, c = i + this.region.width * e, s = l + this.region.height * r, o = this.rotation * Math.PI / 180, a = Math.cos(o), h = Math.sin(o), d = this.x, f = this.y, u = i * a + d, m = i * h, x = l * a + f, y = l * h, b = c * a + d, g = c * h, p = s * a + f, w = s * h, v = this.offset;
    v[0] = u - y, v[1] = x + m, v[2] = u - w, v[3] = p + m, v[4] = b - w, v[5] = p + g, v[6] = b - y, v[7] = x + g, t.degrees == 90 ? (n[0] = t.u2, n[1] = t.v2, n[2] = t.u, n[3] = t.v2, n[4] = t.u, n[5] = t.v, n[6] = t.u2, n[7] = t.v) : (n[0] = t.u, n[1] = t.v2, n[2] = t.u, n[3] = t.v, n[4] = t.u2, n[5] = t.v, n[6] = t.u2, n[7] = t.v2);
  }
  copy() {
    const t = new W(this.name, this.path);
...
W.X1 = 0, W.Y1 = 1, W.C1R = 2, W.C1G = 3, W.C1B = 4, W.C1A = 5, W.U1 = 6, W.V1 = 7, W.X2 = 8, W.Y2 = 9, W.C2R = 10, W.C2G = 11, W.C2B = 12, W.C2A = 13, W.U2 = 14, W.V2 = 15, W.X3 = 16, W.Y3 = 17, W.C3R = 18, W.C3G = 19, W.C3B = 20, W.C3A = 21, W.U3 = 22, W.V3 = 23, W.X4 = 24, W.Y4 = 25, W.C4R = 26, W.C4G = 27, W.C4B = 28, W.C4A = 29, W.U4 = 30, W.V4 = 31;
let wt = W;
class Fs {
  constructor(t) {
    this.atlas = t;
...
var ot = /* @__PURE__ */ ((S) => (S[S.Normal = 0] = "Normal", S[S.OnlyTranslation = 1] = "OnlyTranslation", S[S.NoRotationOrReflection = 2] = "NoRotationOrReflection", S[S.NoScale = 3] = "NoScale", S[S.NoScaleOrReflection = 4] = "NoScaleOrReflection", S))(ot || {});
class Pe {
  ...
  updateWorldTransformWith(t, n, e, r, i, l, c) {
    ...
    switch (this.worldX = o * t + a * n + s.worldX, this.worldY = h * t + d * n + s.worldY, this.data.transformMode) {
      ...
      case ot.NoScaleOrReflection: {
        ...
        const b = Math.PI / 2 + Math.atan2(x, m), g = Math.cos(b) * y, p = Math.sin(b) * y, w = M.cosDeg(l) * r, v = M.cosDeg(90 + c) * i, k = M.sinDeg(l) * r, A = M.sinDeg(90 + c) * i;
        this.a = m * w + g * k, this.b = m * v + g * A, this.c = x * w + p * k, this.d = x * v + p * A;
        break;
      }
    }
...
class Es {
  ...
  apply1(t, n, e, r, i, l, c) {
    ...
    switch (t.data.transformMode) {
      ...
      default:
        const w = n - s.worldX, v = e - s.worldY, k = o * d - a * h;
        Math.abs(k) <= 1e-4 ? (u = 0, m = 0) : (u = (w * d - v * a) / k - t.ax, m = (v * o - w * h) / k - t.ay);
    }
  ...
  apply2(t, n, e, r, i, l, c, s, o) {
    ...
    let p = n.ax, w = 0, v = 0, k = 0, A = t.a, C = t.b, X = t.c, F = t.d;
    const R = Math.abs(d - f) <= 1e-4;
    !R || l ? (w = 0, v = A * p + t.worldX, k = X * p + t.worldY) : (w = n.ay, v = A * p + C * w + t.worldX, k = X * p + F * w + t.worldY);
    const B = t.parent;
    if (!B)
      throw new Error("IK parent must itself have a parent.");
    A = B.a, C = B.b, X = B.c, F = B.d;
    let E = A * F - C * X, I = v - B.worldX, T = k - B.worldY;
    ...
    t:
      if (R) {
        ...
        if (F = yt * yt - 4 * Ct * X, F >= 0) {
          ...
          const Ce = Xt / Ct, Xe = X / Xt, Mt = Math.abs(Ce) < Math.abs(Xe) ? Ce : Xe;
          if (Mt * Mt <= G) {
            T = Math.sqrt(G - Mt * Mt) * i, _ = rt - Math.atan2(T, Mt), j = Math.atan2(T / f, (Mt - L) / d);
            break t;
          }
        }
        let Rt = M.PI, Ut = L - A, ie = Ut * Ut, Ae = 0, Ye = 0, Ot = L + A, re = Ot * Ot, Ie = 0;
        X = -A * L / (J - it), X >= -1 && X <= 1 && (X = Math.acos(X), I = A * Math.cos(X) + L, T = C * Math.sin(X), F = I * I + T * T, F < ie && (Rt = X, ie = F, Ut = I, Ae = T), F > re && (Ye = X, re = F, Ot = I, Ie = T)), G <= (ie + re) * 0.5 ? (_ = rt - Math.atan2(Ae * i, Ut), j = Rt * i) : (_ = rt - Math.atan2(Ie * i, Ot), j = Ye * i);
      }
...
var kt = /* @__PURE__ */ ((S) => (S[S.Fixed = 0] = "Fixed", S[S.Percent = 1] = "Percent", S))(kt || {}), tt = /* @__PURE__ */ ((S) => (S[S.Length = 0] = "Length", S[S.Fixed = 1] = "Fixed", S[S.Percent = 2] = "Percent", S[S.Proportional = 3] = "Proportional", S))(tt || {}), Vt = /* @__PURE__ */ ((S) => (S[S.Tangent = 0] = "Tangent", S[S.Chain = 1] = "Chain", S[S.ChainScale = 2] = "ChainScale", S))(Vt || {});
const nt = class nt {
  constructor(t, n) {
  ...
  update() {
    ...
    for (let g = 0, p = 3; g < o; g++, p += 3) {
      ...
      const v = u[p], k = u[p + 1], A = v - m, C = k - x;
      if (c) {
        const X = d[g];
        if (X != 0) {
  ...
  computeWorldPositions(t, n, e) {
    ...
    let u = 0, m = s[0], x = s[1], y = 0, b = 0, g = 0, p = 0, w = 0, v = 0, k = 0, A = 0, C = 0, X = 0, F = 0, R = 0, B = 0, E = 0;
    for (let O = 0, L = 2; O < h; O++, L += 6)
      y = s[L], b = s[L + 1], g = s[L + 2], p = s[L + 3], w = s[L + 4], v = s[L + 5], k = (m - y * 2 + g) * 0.1875, A = (x - b * 2 + p) * 0.1875, C = ((y - g) * 3 - m + w) * 0.09375, X = ((b - p) * 3 - x + v) * 0.09375, F = k * 2 + C, R = A * 2 + X, B = (y - m) * 0.75 + k + C * 0.16666667, E = (b - x) * 0.75 + A + X * 0.16666667, u += Math.sqrt(B * B + E * E), B += F, E += R, F += C, R += X, u += Math.sqrt(B * B + E * E), B += F, E += R, u += Math.sqrt(B * B + E * E), B += F + C, E += R + X, u += Math.sqrt(B * B + E * E), f[O] = u, m = w, x = v;
    ...
    for (let O = 0, L = 0, H = 0, _ = 0; O < n; O++, L += 3) {
      ...
      if (H != d) {
        d = H;
        let D = H * 6;
        for (m = s[D], x = s[D + 1], y = s[D + 2], b = s[D + 3], g = s[D + 4], p = s[D + 5], w = s[D + 6], v = s[D + 7], k = (m - y * 2 + g) * 0.03, A = (x - b * 2 + p) * 0.03, C = ((y - g) * 3 - m + w) * 6e-3, X = ((b - p) * 3 - x + v) * 6e-3, F = k * 2 + C, R = A * 2 + X, B = (y - m) * 0.3 + k + C * 0.16666667, E = (b - x) * 0.3 + A + X * 0.16666667, N = Math.sqrt(B * B + E * E), T[0] = N, D = 1; D < 8; D++)
      ...
      this.addCurvePosition(U * 0.1, m, x, y, b, g, p, w, v, c, L, e || O > 0 && j == 0);
    }
    return c;
  }
  ...
  addCurvePosition(t, n, e, r, i, l, c, s, o, a, h, d) {
    ...
    const f = t * t, u = f * t, m = 1 - t, x = m * m, y = x * m, b = m * t, g = b * 3, p = m * g, w = g * t, v = n * y + r * p + l * w + s * u, k = e * y + i * p + c * w + o * u;
    a[h] = v, a[h + 1] = k, d && (t < 1e-3 ? a[h + 2] = Math.atan2(i - e, r - n) : a[h + 2] = Math.atan2(k - (e * x + i * b * 2 + c * f), v - (n * x + r * b * 2 + l * f)));
  }
};
...
class Ps {
  ...
  applyAbsoluteWorld() {
    ...
    for (let y = 0, b = x.length; y < b; y++) {
      const g = x[y];
      if (t != 0) {
        const p = g.a, w = g.b, v = g.c, k = g.d;
        let A = Math.atan2(h, o) - Math.atan2(v, p) + u;
        A > M.PI ? A -= M.PI2 : A < -M.PI && (A += M.PI2), A *= t;
        const C = Math.cos(A), X = Math.sin(A);
        g.a = C * p - X * v, g.b = C * w - X * k, g.c = X * p + C * v, g.d = X * w + C * k;
      }
      if (c) {
        const p = this.temp;
      ...
      if (l > 0) {
        const p = g.b, w = g.d, v = Math.atan2(w, p);
        let k = Math.atan2(d, a) - Math.atan2(h, o) - (v - Math.atan2(g.c, g.a));
        k > M.PI ? k -= M.PI2 : k < -M.PI && (k += M.PI2), k = v + (k + m) * l;
  ...
  applyRelativeWorld() {
    ...
    for (let y = 0, b = x.length; y < b; y++) {
      ...
      if (l > 0) {
        ...
        const w = g.b, v = g.d;
        p = Math.atan2(v, w) + (p - M.PI / 2 + m) * l;
        const k = Math.sqrt(w * w + v * v);
...
var Ft = /* @__PURE__ */ ((S) => (S[S.Normal = 0] = "Normal", S[S.Additive = 1] = "Additive", S[S.Multiply = 2] = "Multiply", S[S.Screen = 3] = "Screen", S))(Ft || {});
class bs extends Se {
  constructor(t) {
...
class Rs {
  ...
  readSkeletonData(t) {
    ...
    e.name = "";
    const r = new Ls(t), i = r.readInt32(), l = r.readInt32();
    ...
    for (let a = 0; a < s; a++) {
      ...
      const d = a == 0 ? null : e.bones[r.readInt(!0)], f = new fs(a, h, d);
    ...
    for (let a = 0; a < s; a++) {
      ...
      const d = e.bones[r.readInt(!0)], f = new ps(a, h, d);
  ...
  readSkin(t, n, e, r) {
    ...
    if (e) {
      ...
      i = new pe(c), i.bones.length = t.readInt(!0);
  ...
  readAttachment(t, n, e, r, i, l) {
    ...
    switch (s || (s = i), t.readByte()) {
      ...
      case 3: {
        ...
        return y ? (y.path = o, V.rgba8888ToColor(y.color, a), y.sequence = u, l && (y.width = m * c, y.height = x * c), this.linkedMeshes.push(new Vs(y, h, r, d, f)), y) : null;
      }
      case 4: {
  ...
  readVertices(t, n) {
    const e = this.scale, r = n << 1, i = new Ns();
    if (!t.readBoolean())
  ...
  readAnimation(t, n, e) {
    ...
    for (let o = 0, a = t.readInt(!0); o < a; o++) {
      ...
      for (let d = 0, f = t.readInt(!0); d < f; d++) {
        ...
        switch (u) {
          ...
          case Ks: {
            const y = t.readInt(!0), b = new ts(m, y, h);
            let g = t.readFloat(), p = t.readUnsignedByte() / 255, w = t.readUnsignedByte() / 255, v = t.readUnsignedByte() / 255, k = t.readUnsignedByte() / 255;
            for (let A = 0, C = 0; b.setFrame(A, g, p, w, v, k), A != x; A++) {
              ...
              switch (t.readByte()) {
                case ht:
                  ...
                  break;
                case lt:
                  q(t, b, C++, A, 0, g, X, p, F, 1), q(t, b, C++, A, 1, g, X, w, R, 1), q(t, b, C++, A, 2, g, X, v, B, 1), q(t, b, C++, A, 3, g, X, k, E, 1);
              }
              g = X, p = F, w = R, v = B, k = E;
            }
            r.push(b);
          ...
          case Qs: {
            ...
            let g = t.readFloat(), p = t.readUnsignedByte() / 255, w = t.readUnsignedByte() / 255, v = t.readUnsignedByte() / 255;
            for (let k = 0, A = 0; b.setFrame(k, g, p, w, v), k != x; k++) {
              ...
              switch (t.readByte()) {
                case ht:
                  ...
                  break;
                case lt:
                  q(t, b, A++, k, 0, g, C, p, X, 1), q(t, b, A++, k, 1, g, C, w, F, 1), q(t, b, A++, k, 2, g, C, v, R, 1);
              }
              g = C, p = X, w = F, v = R;
            }
            r.push(b);
          ...
          case Js: {
            const y = t.readInt(!0), b = new ns(m, y, h);
            let g = t.readFloat(), p = t.readUnsignedByte() / 255, w = t.readUnsignedByte() / 255, v = t.readUnsignedByte() / 255, k = t.readUnsignedByte() / 255, A = t.readUnsignedByte() / 255, C = t.readUnsignedByte() / 255, X = t.readUnsignedByte() / 255;
            for (let F = 0, R = 0; b.setFrame(F, g, p, w, v, k, A, C, X), F != x; F++) {
              ...
              switch (t.readByte()) {
                case ht:
                  ...
                  break;
                case lt:
                  q(t, b, R++, F, 0, g, B, p, E, 1), q(t, b, R++, F, 1, g, B, w, I, 1), q(t, b, R++, F, 2, g, B, v, T, 1), q(t, b, R++, F, 3, g, B, k, N, 1), q(t, b, R++, F, 4, g, B, A, O, 1), q(t, b, R++, F, 5, g, B, C, L, 1), q(t, b, R++, F, 6, g, B, X, H, 1);
              }
              g = B, p = E, w = I, v = T, k = N, A = O, C = L, X = H;
            }
            r.push(b);
            break;
          }
          case Zs: {
            ...
            let g = t.readFloat(), p = t.readUnsignedByte() / 255, w = t.readUnsignedByte() / 255, v = t.readUnsignedByte() / 255, k = t.readUnsignedByte() / 255, A = t.readUnsignedByte() / 255, C = t.readUnsignedByte() / 255;
            for (let X = 0, F = 0; b.setFrame(X, g, p, w, v, k, A, C), X != x; X++) {
              ...
              switch (t.readByte()) {
                case ht:
                  ...
                  break;
                case lt:
                  q(t, b, F++, X, 0, g, R, p, B, 1), q(t, b, F++, X, 1, g, R, w, E, 1), q(t, b, F++, X, 2, g, R, v, I, 1), q(t, b, F++, X, 3, g, R, k, T, 1), q(t, b, F++, X, 4, g, R, A, N, 1), q(t, b, F++, X, 5, g, R, C, O, 1);
              }
              g = R, p = B, w = E, v = I, k = T, A = N, C = O;
            }
            r.push(b);
            break;
          }
          case tn: {
            const y = new ss(m, t.readInt(!0), h);
            let b = t.readFloat(), g = t.readUnsignedByte() / 255;
            for (let p = 0, w = 0; y.setFrame(p, b, g), p != x; p++) {
              const v = t.readFloat(), k = t.readUnsignedByte() / 255;
              switch (t.readByte()) {
                case ht:
                  y.setStepped(p);
                  break;
                case lt:
                  q(t, y, w++, p, 0, b, v, g, k, 1);
              }
              b = v, g = k;
            }
            r.push(y);
      ...
      for (let d = 0, f = t.readInt(!0); d < f; d++) {
        ...
        switch (u) {
          case Ds:
            ...
            break;
          case Us:
            r.push(le(t, new $e(m, x, h), i));
            break;
          case Os:
            r.push(pt(t, new He(m, x, h), i));
            break;
          case qs:
            r.push(pt(t, new Ge(m, x, h), i));
            break;
          case Ws:
            r.push(le(t, new je(m, x, h), 1));
            break;
          case zs:
            r.push(pt(t, new _e(m, x, h), 1));
            break;
          case $s:
            r.push(pt(t, new Ke(m, x, h), 1));
            break;
          case Hs:
            r.push(le(t, new Qe(m, x, h), 1));
            break;
          case Gs:
            r.push(pt(t, new Je(m, x, h), 1));
            break;
          case js:
    ...
    for (let o = 0, a = t.readInt(!0); o < a; o++) {
      const h = t.readInt(!0), d = t.readInt(!0), f = d - 1, u = new as(d, t.readInt(!0), h);
      ...
      for (let b = 0, g = 0; u.setFrame(b, m, x, y, t.readByte(), t.readBoolean(), t.readBoolean()), b != f; b++) {
        const p = t.readFloat(), w = t.readFloat(), v = t.readFloat() * i;
        switch (t.readByte()) {
          case ht:
            u.setStepped(b);
            break;
          case lt:
            q(t, u, g++, b, 0, m, p, x, w, 1), q(t, u, g++, b, 1, m, p, y, v, i);
        }
        m = p, x = w, y = v;
      }
      r.push(u);
    ...
    for (let o = 0, a = t.readInt(!0); o < a; o++) {
      ...
      for (let v = 0, k = 0; u.setFrame(v, m, x, y, b, g, p, w), v != f; v++) {
        ...
        switch (t.readByte()) {
          case ht:
            ...
            break;
          case lt:
            q(t, u, k++, v, 0, m, A, x, C, 1), q(t, u, k++, v, 1, m, A, y, X, 1), q(t, u, k++, v, 2, m, A, b, F, 1), q(t, u, k++, v, 3, m, A, g, R, 1), q(t, u, k++, v, 4, m, A, p, B, 1), q(t, u, k++, v, 5, m, A, w, E, 1);
        }
        ...
        switch (t.readByte()) {
          case nn:
            r.push(
              pt(
                t,
                new cs(t.readInt(!0), t.readInt(!0), h),
          ...
          case rn:
            ...
            break;
          case an:
            const m = new ls(t.readInt(!0), t.readInt(!0), h);
            let x = t.readFloat(), y = t.readFloat(), b = t.readFloat(), g = t.readFloat();
            for (let p = 0, w = 0, v = m.getFrameCount() - 1; m.setFrame(p, x, y, b, g), p != v; p++) {
    ...
    for (let o = 0, a = t.readInt(!0); o < a; o++) {
      ...
      for (let d = 0, f = t.readInt(!0); d < f; d++) {
        ...
        for (let m = 0, x = t.readInt(!0); m < x; m++) {
          ...
          switch (g) {
            case en: {
              const v = b, k = v.bones, A = v.vertices, C = k ? A.length / 3 * 2 : A.length, X = t.readInt(!0), F = new rs(p, X, u, v);
              let R = t.readFloat();
              for (let B = 0, E = 0; ; B++) {
                let I, T = t.readInt(!0);
                if (T == 0)
    ...
    if (c > 0) {
      const o = new Nt(c);
      for (let a = 0; a < c; a++) {
        const h = t.readFloat(), d = e.events[t.readInt(!0)], f = new us(h, d);
...
function pt(S, t, n) {
  let e = S.readFloat(), r = S.readFloat() * n;
  for (let i = 0, l = 0, c = t.getFrameCount() - 1; t.setFrame(i, e, r), i != c; i++) {
    const s = S.readFloat(), o = S.readFloat() * n;
    switch (S.readByte()) {
      case ht:
        t.setStepped(i);
        break;
      case lt:
        q(S, t, l++, i, 0, e, s, r, o, n);
    }
    e = s, r = o;
  }
  return t;
...
function le(S, t, n) {
  let e = S.readFloat(), r = S.readFloat() * n, i = S.readFloat() * n;
  for (let l = 0, c = 0, s = t.getFrameCount() - 1; t.setFrame(l, e, r, i), l != s; l++) {
    const o = S.readFloat(), a = S.readFloat() * n, h = S.readFloat() * n;
    switch (S.readByte()) {
      case ht:
        t.setStepped(l);
        break;
      case lt:
        q(S, t, c++, l, 0, e, o, r, a, n), q(S, t, c++, l, 1, e, o, i, h, n);
    }
    e = o, r = a, i = h;
  }
  return t;
}
function q(S, t, n, e, r, i, l, c, s, o) {
  t.setBezier(
    n,
    e,
    r,
...
const Ds = 0, Us = 1, Os = 2, qs = 3, Ws = 4, zs = 5, $s = 6, Hs = 7, Gs = 8, js = 9, _s = 0, Ks = 1, Qs = 2, Js = 3, Zs = 4, tn = 5, en = 0, sn = 1, nn = 0, rn = 1, an = 2, ht = 1, lt = 2;
class on {
  constructor() {
...
class st {
  ...
  decompose(t, n) {
    ...
    for (let a = 0, h = n.length; a < h; a += 3) {
      ...
      let w = !1;
      if (s == d) {
        const v = c.length - 4, k = st.winding(c[v], c[v + 1], c[v + 2], c[v + 3], g, p), A = st.winding(g, p, c[0], c[1], c[2], c[3]);
    ...
    for (let a = 0, h = r.length; a < h; a++) {
      ...
      const g = c[0], p = c[1], w = c[2], v = c[3], k = st.winding(m, x, y, b, g, p);
      for (let A = 0; A < h; A++) {
        if (A == a)
          continue;
        const C = i[A];
        ...
        if (X != d || F != f)
          continue;
        const T = st.winding(m, x, y, b, E, I), N = st.winding(E, I, g, p, w, v);
...
class Qt {
  ...
  clipTriangles(t, n, e, r, i, l, c, s) {
    ...
    t:
      for (let x = 0; x < r; x += 3) {
        ...
        y = e[x + 1] << 1;
        const v = t[y], k = t[y + 1], A = i[y], C = i[y + 1];
        y = e[x + 2] << 1;
        const X = t[y], F = t[y + 1], R = i[y], B = i[y + 1];
        for (let E = 0; E < f; E++) {
          let I = a.length;
          if (this.clip(b, g, v, k, X, F, d[E], o)) {
            const T = o.length;
            if (T == 0)
              continue;
            const N = k - F, O = X - v, L = b - X, H = F - g, _ = 1 / (N * L + O * (g - F));
            let j = T >> 1;
            ...
            T[I] = b, T[I + 1] = g, T[I + 2] = l.r, T[I + 3] = l.g, T[I + 4] = l.b, T[I + 5] = l.a, s ? (T[I + 6] = p, T[I + 7] = w, T[I + 8] = c.r, T[I + 9] = c.g, T[I + 10] = c.b, T[I + 11] = c.a, T[I + 12] = v, T[I + 13] = k, T[I + 14] = l.r, T[I + 15] = l.g, T[I + 16] = l.b, T[I + 17] = l.a, T[I + 18] = A, T[I + 19] = C, T[I + 20] = c.r, T[I + 21] = c.g, T[I + 22] = c.b, T[I + 23] = c.a, T[I + 24] = X, T[I + 25] = F, T[I + 26] = l.r, T[I + 27] = l.g, T[I + 28] = l.b, T[I + 29] = l.a, T[I + 30] = R, T[I + 31] = B, T[I + 32] = c.r, T[I + 33] = c.g, T[I + 34] = c.b, T[I + 35] = c.a) : (T[I + 6] = p, T[I + 7] = w, T[I + 8] = v, T[I + 9] = k, T[I + 10] = l.r, T[I + 11] = l.g, T[I + 12] = l.b, T[I + 13] = l.a, T[I + 14] = A, T[I + 15] = C, T[I + 16] = X, T[I + 17] = F, T[I + 18] = l.r, T[I + 19] = l.g, T[I + 20] = l.b, T[I + 21] = l.a, T[I + 22] = R, T[I + 23] = B), I = h.length;
  ...
  clip(t, n, e, r, i, l, c, s) {
    ...
    for (let u = 0; ; u += 2) {
      const m = d[u], x = d[u + 1], y = d[u + 2], b = d[u + 3], g = m - y, p = x - b, w = h, v = h.length - 2, k = s.length;
      for (let C = 0; C < v; C += 2) {
  ...
  readSkeletonData(t) {
    ...
    if (i && (e.hash = i.hash, e.version = i.spine, e.x = i.x, e.y = i.y, e.width = i.width, e.height = i.height, e.fps = i.fps, e.imagesPath = i.images), r.bones)
      for (let l = 0; l < r.bones.length; l++) {
        ...
        o && (s = e.findBone(o));
        const a = new fs(e.bones.length, c.name, s);
    ...
    if (r.slots)
      for (let l = 0; l < r.slots.length; l++) {
        ...
        const o = new ps(e.slots.length, c.name, s), a = Y(c, "color", null);
    ...
    if (r.ik)
      for (let l = 0; l < r.ik.length; l++) {
        const c = r.ik[l], s = new gs(c.name);
    ...
    if (r.transform)
      for (let l = 0; l < r.transform.length; l++) {
        const c = r.transform[l], s = new bs(c.name);
        s.order = Y(c, "order", 0), s.skinRequired = Y(c, "skin", !1);
    ...
    if (r.path)
      for (let l = 0; l < r.path.length; l++) {
        const c = r.path[l], s = new xs(c.name);
        s.order = Y(c, "order", 0), s.skinRequired = Y(c, "skin", !1);
        for (let h = 0; h < c.bones.length; h++) {
          const d = c.bones[h], f = e.findBone(d);
          if (!f)
    ...
    if (r.skins)
      for (let l = 0; l < r.skins.length; l++) {
        const c = r.skins[l], s = new pe(c.name);
        if (c.bones)
  ...
  readAnimation(t, n, e) {
        ...
        for (const h in s) {
          ...
          if (h == "attachment") {
            ...
            for (let b = 0, g = 0; ; b++) {
              ...
              const w = Y(p, "time", 0), v = V.fromString(p.color), k = m.curve;
              k && (g = z(k, u, g, b, 0, x, w, y.r, v.r, 1), g = z(k, u, g, b, 1, x, w, y.g, v.g, 1), g = z(k, u, g, b, 2, x, w, y.b, v.b, 1), g = z(k, u, g, b, 3, x, w, y.a, v.a, 1)), x = w, y = v, m = p;
            }
            i.push(u);
          } else if (h == "rgb") {
            const u = new es(f, f * 3, a);
            let m = d[0], x = Y(m, "time", 0), y = V.fromString(m.color);
            for (let b = 0, g = 0; ; b++) {
              ...
              const w = Y(p, "time", 0), v = V.fromString(p.color), k = m.curve;
              k && (g = z(k, u, g, b, 0, x, w, y.r, v.r, 1), g = z(k, u, g, b, 1, x, w, y.g, v.g, 1), g = z(k, u, g, b, 2, x, w, y.b, v.b, 1)), x = w, y = v, m = p;
            }
            i.push(u);
          } else if (h == "alpha")
            i.push(ut(d, new ss(f, f, a), 0, 1));
          else if (h == "rgba2") {
            const u = new ns(f, f * 7, a);
            ...
            for (let g = 0, p = 0; ; g++) {
              ...
              const v = Y(w, "time", 0), k = V.fromString(w.light), A = V.fromString(w.dark), C = m.curve;
              C && (p = z(C, u, p, g, 0, x, v, y.r, k.r, 1), p = z(C, u, p, g, 1, x, v, y.g, k.g, 1), p = z(C, u, p, g, 2, x, v, y.b, k.b, 1), p = z(C, u, p, g, 3, x, v, y.a, k.a, 1), p = z(C, u, p, g, 4, x, v, b.r, A.r, 1), p = z(C, u, p, g, 5, x, v, b.g, A.g, 1), p = z(C, u, p, g, 6, x, v, b.b, A.b, 1)), x = v, y = k, b = A, m = w;
            }
            i.push(u);
          } else if (h == "rgb2") {
            const u = new is(f, f * 6, a);
            let m = d[0], x = Y(m, "time", 0), y = V.fromString(m.light), b = V.fromString(m.dark);
            for (let g = 0, p = 0; ; g++) {
              ...
              const v = Y(w, "time", 0), k = V.fromString(w.light), A = V.fromString(w.dark), C = m.curve;
              C && (p = z(C, u, p, g, 0, x, v, y.r, k.r, 1), p = z(C, u, p, g, 1, x, v, y.g, k.g, 1), p = z(C, u, p, g, 2, x, v, y.b, k.b, 1), p = z(C, u, p, g, 3, x, v, b.r, A.r, 1), p = z(C, u, p, g, 4, x, v, b.g, A.g, 1), p = z(C, u, p, g, 5, x, v, b.b, A.b, 1)), x = v, y = k, b = A, m = w;
            }
            i.push(u);
          }
        }
        ...
        for (const h in s) {
          ...
          if (f != 0) {
            if (h === "rotate")
              ...
              const u = new $e(f, f << 1, a);
              i.push(de(d, u, "x", "y", 0, r));
            } else if (h === "translatex") {
              const u = new He(f, f, a);
              i.push(ut(d, u, 0, r));
              ...
              i.push(de(d, u, "x", "y", 1, 1));
            } else if (h === "scalex") {
              const u = new _e(f, f, a);
              i.push(ut(d, u, 1, 1));
            } else if (h === "scaley") {
              const u = new Ke(f, f, a);
              i.push(ut(d, u, 1, 1));
            } else if (h === "shear") {
              const u = new Qe(f, f << 1, a);
              i.push(de(d, u, "x", "y", 0, 1));
            } else if (h === "shearx") {
    ...
    if (t.ik)
      for (const c in t.ik) {
        ...
        const h = e.ikConstraints.indexOf(a), d = new as(s.length, s.length << 1, h);
        ...
        for (let x = 0, y = 0; ; x++) {
          ...
          const g = Y(b, "time", 0), p = Y(b, "mix", 1), w = Y(b, "softness", 0) * r, v = o.curve;
          v && (y = z(v, d, y, x, 0, f, g, u, p, 1), y = z(v, d, y, x, 1, f, g, m, w, r)), f = g, u = p, m = w, o = b;
        }
        i.push(d);
      }
    if (t.transform)
      for (const c in t.transform) {
        ...
        const h = e.transformConstraints.indexOf(a), d = new os(s.length, s.length * 6, h);
        ...
        for (let p = 0, w = 0; ; p++) {
          ...
          const k = Y(v, "time", 0), A = Y(v, "mixRotate", 1), C = Y(v, "mixX", 1), X = Y(v, "mixY", C), F = Y(v, "mixScaleX", 1), R = Y(v, "mixScaleY", F), B = Y(v, "mixShearY", 1), E = o.curve;
          E && (w = z(E, d, w, p, 0, f, k, u, A, 1), w = z(E, d, w, p, 1, f, k, m, C, 1), w = z(E, d, w, p, 2, f, k, x, X, 1), w = z(E, d, w, p, 3, f, k, y, F, 1), w = z(E, d, w, p, 4, f, k, b, R, 1), w = z(E, d, w, p, 5, f, k, g, B, 1)), f = k, u = A, m = C, x = X, y = F, b = R, y = F, o = v;
        }
        i.push(d);
      }
    if (t.path)
        ...
        for (const h in s) {
          ...
          if (h === "position") {
            ...
            for (let p = 0, w = 0; ; p++) {
              ...
              const k = Y(v, "time", 0), A = Y(v, "mixRotate", 1), C = Y(v, "mixX", 1), X = Y(v, "mixY", C), F = f.curve;
              F && (w = z(F, m, w, p, 0, x, k, y, A, 1), w = z(F, m, w, p, 1, x, k, b, C, 1), w = z(F, m, w, p, 2, x, k, g, X, 1)), x = k, y = A, b = C, g = X, f = v;
            }
            i.push(m);
          }
        }
        ...
        for (const a in s) {
          ...
          for (const u in h) {
            ...
            for (const y in m) {
              ...
              if (g) {
                if (y == "deform") {
                  const p = x.bones, w = x.vertices, v = p ? w.length / 3 * 2 : w.length, k = new rs(b.length, b.length, f, x);
                  let A = Y(g, "time", 0);
                  for (let C = 0, X = 0; ; C++) {
                    let F;
                    const R = Y(g, "vertices", null);
                    if (!R)
                      F = p ? P.newFloatArray(v) : w;
                    else {
                      F = P.newFloatArray(v);
                    ...
                    I && (X = z(I, k, X, C, 0, A, E, 0, 1, 1)), A = E, g = B;
                  }
                  i.push(k);
                } else if (y == "sequence") {
                  const p = new _t(
                  ...
                  for (let v = 0; v < b.length; v++) {
                    ...
                    p.setFrame(v, A, C, X, k), w = k, g = b[v + 1];
                  }
                  i.push(p);
                }
              }
    ...
    if (t.events) {
      ...
      for (let o = 0; o < t.events.length; o++, s++) {
        ...
        const d = new us(P.toSinglePrecision(Y(a, "time", 0)), h);
    ...
    e.animations.push(new we(n, i, l));
  }
}
class hn {
  constructor(t, n, e, r, i) {
...
function ut(S, t, n, e) {
  let r = S[0], i = Y(r, "time", 0), l = Y(r, "value", n) * e, c = 0;
  for (let s = 0; ; s++) {
    t.setFrame(s, i, l);
    const o = S[s + 1];
    if (!o)
    ...
    r.curve && (c = z(r.curve, t, c, s, 0, i, a, l, h, e)), i = a, l = h, r = o;
  }
}
function de(S, t, n, e, r, i) {
  let l = S[0], c = Y(l, "time", 0), s = Y(l, n, r) * i, o = Y(l, e, r) * i, a = 0;
  for (let h = 0; ; h++) {
    t.setFrame(h, c, s, o);
    const d = S[h + 1];
    if (!d)
    ...
    x && (a = z(x, t, a, h, 0, c, f, s, u, i), a = z(x, t, a, h, 1, c, f, o, m, i)), c = f, s = u, o = m, l = d;
  }
}
function z(S, t, n, e, r, i, l, c, s, o) {
  if (S == "stepped")
    return t.setStepped(e), n;
  const a = r << 2, h = S[a], d = S[a + 1] * o, f = S[a + 2], u = S[a + 3] * o;
  return t.setBezier(n, e, r, i, c, h, d, f, u, l, s), n + 1;
}
function Y(S, t, n) {
  return S[t] !== void 0 ? S[t] : n;
}
typeof Math.fround > "u" && (Math.fround = /* @__PURE__ */ function(S) {
  return function(t) {
    return S[0] = t, S[0];
  };
}(new Float32Array(1)));
const dt = class dt extends Is {
  constructor(t) {
    super(t.resource), this.texture = ue.from(t);
  }
  static from(t) {
...
const vn = {
  ...
  loader: {
    ...
    async load(S) {
      return await (await Oe.get().fetch(S)).text();
    },
    testParse(S, t) {
      const n = Lt(t.src, ".atlas"), e = typeof S == "string";
    ...
    async parse(S, t, n) {
      ...
      const i = new Xs(S);
      if (e.images instanceof Me || typeof e.images == "string") {
        const c = e.images;
...
const Sn = {
  ...
  loader: {
    ...
    async load(S) {
      const t = await Oe.get().fetch(S);
      return new Uint8Array(await t.arrayBuffer());
    },
    testParse(S, t) {
      const n = Lt(t.src, ".json") && ln(S), e = Lt(t.src, ".skel") && dn(S);
      return Promise.resolve(n || e);
    }
  }
};
class fn {
  ...
  setClipper(t) {
    Le(t.clippedVertices, this.clippedVertices), Le(t.clippedTriangles, this.clippedTriangles), this.vertexSize = t.clippedVertices.length / 8, this.indexSize = t.clippedTriangles.length;
  }
  packIndex(t, n, e) {
...
class mn {
  ...
  packIndex(t, n, e) {
    const r = this.slot.getAttachment().triangles ?? un;
    for (let i = 0; i < r.length; i++)
      t[n++] = r[i] + e;
  }
  packAttributes(t, n, e, r) {
    ...
    const d = a.a * o * 255;
    if (s !== 16777215) {
      const v = s >> 16 & 255, k = s >> 8 & 255, A = s & 255, C = a.r * A * 255, X = a.g * k * 255, F = a.b * v * 255;
      h = d << 24 | F << 16 | X << 8 | C;
    } else
    ...
    for (let v = 0; v < c; v++) {
      const k = t[e], A = -t[e + 1];
      t[e++] = m * k + y * A + g, t[e++] = x * k + b * A + p, t[e++] = f[v * 2], t[e++] = f[v * 2 + 1], n[e++] = h, n[e++] = w;
    }
  }
}
const Ve = [0, 1, 2, 2, 3, 0], fe = new Float32Array(8), gn = new V(), xn = new V(), ke = class ke {
  constructor(t) {
        ...
        if (l != null && l.isClipping()) {
          if (d instanceof wt) {
            ...
            if (d.computeWorldVertices(h, f, 0, 2), l.clipTriangles(
              ...
              const u = ae.get(fn);
              i.push(u), u.texture = ((c = d.region) == null ? void 0 : c.texture.texture) || ue.WHITE, u.roundPixels = this.renderer._roundPixels | t._roundPixels, u.setClipper(l), u.renderable = t, n.addToBatch(u);
            }
          }
        } else {
          const f = ae.get(mn);
          i.push(f), f.renderable = t, f.setSlot(h), f.texture = ((s = d.region) == null ? void 0 : s.texture.texture) || ue.EMPTY, f.roundPixels = this.renderer._roundPixels | t._roundPixels, n.addToBatch(f);
        }
      else
...
let Ne = ke;
const pn = new Float32Array(8), De = [];
function bn(S, t) {
  t.clear();
  const n = S.getRootBone();
  n.x = 0, n.y = 0, n.scaleX = 1, n.scaleY = -1, n.rotation = 0, S.updateWorldTransform();
  const e = S.drawOrder;
  for (let r = 0, i = e.length; r < i; r++) {
    ...
    if (c instanceof wt) {
      ...
      c instanceof mt ? (c.computeWorldVertices(l, 0, c.worldVerticesLength, De, 0, 2), t.addVertexData(De, 0, c.worldVerticesLength)) : c instanceof Dt && console.warn("[Pixi Spine] ClippingAttachment bounds is not supported yet");
  }
}
const zt = new Ht();
class be extends ws {
  constructor(t) {
    t instanceof Kt && (t = {
      skeletonData: t
    }), super(), this.batched = !0, this.buildId = 0, this.renderPipeId = "spine", this._didSpineUpdate = !1, this._boundsDirty = !0, this.autoUpdateWarned = !1, this._bounds = new ys(), this._debug = void 0, this._autoUpdate = !0;
    const n = t instanceof Kt ? t : t.skeletonData;
    this.skeleton = new xe(n), this.state = new me(new Ys(n)), this.autoUpdate = (t == null ? void 0 : t.autoUpdate) ?? !0;
  }
  ...
  set autoUpdate(t) {
    t ? (Wt.shared.add(this.internalUpdate, this), this.autoUpdateWarned = !1) : Wt.shared.remove(this.internalUpdate, this), this._autoUpdate = t;
  }
  static from({ skeleton: t, atlas: n, scale: e = 1 }) {
    const r = `${t}-${n}`;
    if (oe.has(r))
      return new be(oe.get(r));
    const i = Te.get(t), l = Te.get(n), c = new Fs(l), s = i instanceof Uint8Array ? new Rs(c) : new cn(c);
    s.scale = e;
    const o = s.readSkeletonData(i);
    return oe.set(r, o), new be({
      skeletonData: o
    });
  }
  update(t) {
  ...
  setBonePosition(t, n) {
    ...
    if (zt.set(n.x, n.y), t.parent) {
      const r = t.parent.worldToLocal(zt);
      t.x = r.x, t.y = r.y;
    } else
      t.x = zt.x, t.y = zt.y;
  }
  ...
  updateBounds() {
    this._boundsDirty = !1, this.skeletonBounds || (this.skeletonBounds = new on());
    const t = this.skeletonBounds;
    t.update(this.skeleton, !0), t.minX === 1 / 0 ? (this.state.apply(this.skeleton), bn(this.skeleton, this._bounds)) : (this._bounds.minX = t.minX, this._bounds.minY = t.minY, this._bounds.maxX = t.maxX, this._bounds.maxY = t.maxY);
  }
  addBounds(t) {
   ...
   */
  destroy(t = !1) {
    super.destroy(t), Wt.shared.remove(this.internalUpdate, this), this.state.clearListeners(), this.debug = void 0, this.skeleton = null, this.state = null;
  }
  internalUpdate(t, n) {
    this.updateState(n ?? Wt.shared.deltaMS / 1e3);
  }
}
export {
  ss as AlphaTimeline,
  we as Animation,
  me as AnimationState,
  Ys as AnimationStateData,
  Fs as AtlasAttachmentLoader,
  We as Attachment,
  Tt as AttachmentTimeline,
  Ls as BinaryInput,
  Ft as BlendMode,
  Pe as Bone,
  fs as BoneData,
  ne as BoundingBoxAttachment,
  As as CURRENT,
  Dt as ClippingAttachment,
  V as Color,
  Se as ConstraintData,
  gt as CurveTimeline,
  xt as CurveTimeline1,
  ye as CurveTimeline2,
  rs as DeformTimeline,
  It as DrawOrderTimeline,
  us as Event,
  ms as EventData,
  Ss as EventQueue,
  Nt as EventTimeline,
  ...
  he as HOLD_FIRST,
  ks as HOLD_MIX,
  Ee as HOLD_SUBSEQUENT,
  Es as IkConstraint,
  gs as IkConstraintData,
  as as IkConstraintTimeline,
  M as MathUtils,
  mt as MeshAttachment,
  Q as MixBlend,
  At as MixDirection,
  Pt as PathAttachment,
  ge as PathConstraint,
  xs as PathConstraintData,
  ls as PathConstraintMixTimeline,
  cs as PathConstraintPositionTimeline,
  hs as PathConstraintSpacingTimeline,
  ve as PointAttachment,
  $t as Pool,
  kt as PositionMode,
  is as RGB2Timeline,
  ns as RGBA2Timeline,
  ts as RGBATimeline,
  es as RGBTimeline,
  wt as RegionAttachment,
  Vt as RotateMode,
  jt as RotateTimeline,
  Be as SETUP,
  ce as SUBSEQUENT,
  je as ScaleTimeline,
  _e as ScaleXTimeline,
  Ke as ScaleYTimeline,
  _t as SequenceTimeline,
  Qe as ShearTimeline,
  Je as ShearXTimeline,
  Ze as ShearYTimeline,
  xe as Skeleton,
  Rs as SkeletonBinary,
  on as SkeletonBounds,
  Qt as SkeletonClipping,
  Kt as SkeletonData,
  cn as SkeletonJson,
  pe as Skin,
  Re as SkinEntry,
  ...
  Is as Texture,
  Xs as TextureAtlas,
  Ts as TextureAtlasPage,
  ds as TextureAtlasRegion,
  Z as TextureFilter,
  Cs as TextureRegion,
  St as TextureWrap,
  K as Timeline,
  vs as TrackEntry,
  Ps as TransformConstraint,
  bs as TransformConstraintData,
  os as TransformConstraintTimeline,
  ot as TransformMode,
  $e as TranslateTimeline,
  He as TranslateXTimeline,
  Ge as TranslateYTimeline,
  st as Triangulator,
  P as Utils,
  Ht as Vector2,
  ft as VertexAttachment,
  Sn as spineLoaderExtension,
  vn as spineTextureAtlasLoader
};
//# sourceMappingURL=index-COi_UROb.mjs.map
