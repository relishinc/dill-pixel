...
import { Assets, BitmapText, DRAW_MODES, Graphics, HTMLText, Mesh, NineSlicePlane, Point, SimpleMesh, SimplePlane, SimpleRope, Text, Texture, TilingSprite } from 'pixi.js';
import { Application } from '../../core';
import { AnimatedSprite, Container, FlexContainer, Sprite, SpriteAnimation } from '../../gameobjects';
...
export class Make {
    ...
    // spriteAnimation
    static spriteAnimation(props) {
        return new SpriteAnimation(props);
    }
    // animatedSprite
    static animatedSprite(settings) {
        let visible = true;
        let alpha = 1;
