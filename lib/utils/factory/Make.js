...
export class Make {
    ...
    static coloredSprite(settingsOrColor = 0x0, size = {
        x: 1,
        y: 1,
    }, shape = 'rectangle', opts, alpha = 1, position = [0, 0], anchor = [0.5, 0.5], scale = [1, 1]) {
    ...
    static sprite(settingsOrAsset, sheet, alpha, position, anchor, scale) {
        let visible = true;
        let sprite;
    ...
    static text(settingsOrValue = '', style, alpha = 1, position = 0, anchor = 0.5, scale = 1) {
    ...
    static htmlText(settingsOrValue = '', style, alpha = 1, position = 0, anchor = 0.5, scale = 1) {
        let value = settingsOrValue;
        let visible = true;
        if (typeof settingsOrValue === 'object') {
            const settings = settingsOrValue;
    ...
    static bitmapText(settingsOrValue = '', style, alpha = 1, position = 0, anchor = 0.5, scale = 1) {
        let value = settingsOrValue;
        let visible = true;
        if (typeof settingsOrValue === 'object') {
            const settings = settingsOrValue;
    ...
    static container(settingsOrAlpha = 1, position = 0, scale = 1) {
        let visible = true;
    ...
    static flexContainer(settingsOrAlpha = 1, position = 0, settings = {}, scale = 1) {
        let visible = true;
        let alpha = settingsOrAlpha;
        let container;
        if (typeof settingsOrAlpha === 'object') {
    ...
    static graphics(settingsOrAlpha = 1, position = 0, scale = 1) {
        let visible = true;
        let alpha = settingsOrAlpha;
        if (typeof settingsOrAlpha === 'object') {
            const settings = settingsOrAlpha;
    ...
    static tilingSprite(settingsOrAsset, sheet, width = 1, height = 1, tilePosition = 0, alpha = 1, position = 0, anchor = 0.5, scale = 1) {
        let visible = true;
        let asset = settingsOrAsset;
    ...
    static simpleRope(settingsOrAsset, sheet, numPoints = 25, segmentLength = 50, autoUpdate, alpha = 1, position = 0, scale = 1) {
        let visible = true;
        let asset = settingsOrAsset;
        if (typeof settingsOrAsset !== 'string' && !(settingsOrAsset instanceof Texture)) {
            const settings = settingsOrAsset;
    ...
    static simplePlane(settingsOrAsset, sheet, vertsWidth = 1, vertsHeight = 1, alpha = 1, position = 0, scale = 1) {
        let visible = true;
        let asset = settingsOrAsset;
        if (typeof settingsOrAsset !== 'string' && !(settingsOrAsset instanceof Texture)) {
            const settings = settingsOrAsset;
    ...
    static simpleMesh(settingsOrAsset, sheet, vertices, uvs, indices, drawMode, alpha = 1, position = 0, scale = 1) {
        let visible = true;
        let asset = settingsOrAsset;
        if (typeof settingsOrAsset !== 'string' && !(settingsOrAsset instanceof Texture)) {
            const settings = settingsOrAsset;
    ...
    static nineSlice(settingsOrAsset, sheet, leftWidth = 10, topHeight = 10, rightWidth = 10, bottomHeight = 10, alpha = 1, position = 0, scale = 1) {
        let visible = true;
        let asset = settingsOrAsset;
        if (typeof settingsOrAsset !== 'string' && !(settingsOrAsset instanceof Texture)) {
            const settings = settingsOrAsset;
