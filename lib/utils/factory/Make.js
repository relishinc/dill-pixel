...
export class Make {
    ...
    static text(settingsOrValue = '', style, alpha = 1, position = 0, anchor = 0, scale = 1) {
    ...
    static htmlText(settingsOrValue = '', style, alpha = 1, position = 0, anchor = 0, scale = 1) {
        let value = settingsOrValue;
        let visible = true;
        if (typeof settingsOrValue === 'object') {
            const settings = settingsOrValue;
    ...
    static bitmapText(settingsOrValue = '', style, alpha = 1, position = 0, anchor = 0, scale = 1) {
        let value = settingsOrValue;
        let visible = true;
        if (typeof settingsOrValue === 'object') {
            const settings = settingsOrValue;
