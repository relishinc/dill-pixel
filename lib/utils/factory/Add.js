...
export class Add {
    ...
    existing(pObject, settingsOrPosition = 0, anchor = 0, scale = 1) {
    ...
    text(settingsOrValue = '', style, alpha = 1, position = 0, anchor = 0, scale = 1) {
    ...
    htmlText(settingsOrValue = '', style, alpha = 1, position = 0, anchor = 0, scale = 1) {
    ...
    bitmapText(settingsOrValue = '', style, alpha = 1, position = 0, anchor = 0, scale = 1) {
