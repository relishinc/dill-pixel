export class Colour {
    static { this.WHITE = new Colour(255, 255, 255); }
    static { this.BLACK = new Colour(0, 0, 0); }
    static { this.GREY = new Colour(127, 127, 127); }
    static { this.RED = new Colour(255, 0, 0); }
    static { this.GREEN = new Colour(0, 255, 0); }
    static { this.BLUE = new Colour(0, 0, 255); }
    static { this.YELLOW = new Colour(255, 255, 0); }
    static { this.MAGENTA = new Colour(255, 0, 255); }
    static { this.CYAN = new Colour(0, 255, 255); }
    /**
